...
/**
 * 总体说明：
 * 1.默认容量 16 最大容量 2的31次方-1
 * 2.默认负载因子0.75
 * 3.链表长度变树的阀值8、红黑树变链表阀值6，最小的tree容量 64
 * 4.Node节点，用于实现节点和红黑树
 */
 ...
 * <p>
 * 许多key使用同样的hashCode方法会降低哈希表的性能，为了降低这种影响，当key是可比较的时候，这个类可以实用比较方法来帮助提高性能
 * <p>
 * <p>
...
public class HashMap<K, V> extends AbstractMap<K, V>
     ...
     * 基本的节点数据结构（子类TreeNode和LinkedHashMap），可修改
     */
    static class Node<K, V> implements Map.Entry<K, V> {
        ...
        public final int hashCode() {  // 哈希值的计算是key和value值的异或
