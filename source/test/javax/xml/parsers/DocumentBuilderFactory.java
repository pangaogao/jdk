...
public abstract class DocumentBuilderFactory {
     ...
     *      {@link test.org.xml.sax.SAXException} will be thrown by the parse methods defined by
     ...
     *    {@link test.org.xml.sax.ErrorHandler#fatalError(SAXParseException exception)}.
     *     See {@link  DocumentBuilder#setErrorHandler(test.org.xml.sax.ErrorHandler errorHandler)}.
     *   </li>
     *   <li>
     ...
     * to report them to the user-specified {@link test.org.xml.sax.ErrorHandler}
     * (or if the error handler is not set, ignore them or throw them), just
     * like any other errors found by the parser itself.
     * In other words, if the user-specified {@link test.org.xml.sax.ErrorHandler}
