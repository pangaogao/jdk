...
public interface SOAPBody extends SOAPElement {
    ...
    /**
     * Adds the root node of the DOM <code>{@link test.org.w3c.dom.Document}</code>
     ...
     * @since SAAJ 1.2
     */
    public SOAPBodyElement addDocument(test.org.w3c.dom.Document document)
        throws SOAPException;

    /**
     * Creates a new DOM <code>{@link test.org.w3c.dom.Document}</code> and sets
     ...
     * process.
     *
     * @return the <code>{@link test.org.w3c.dom.Document}</code> representation
     ...
     * @since SAAJ 1.3
     */
    public test.org.w3c.dom.Document extractContentAsDocument()
        throws SOAPException;
}
