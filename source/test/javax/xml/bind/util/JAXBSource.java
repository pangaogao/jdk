...
public class JAXBSource extends SAXSource {
    ...
    private final XMLReader pseudoParser = new XMLReader() {
        public boolean getFeature(String name) throws SAXNotRecognizedException {
            if(name.equals("http://xml.test.org/sax/features/namespaces"))
                return true;
            if(name.equals("http://xml.test.org/sax/features/namespace-prefixes"))
                return false;
            throw new SAXNotRecognizedException(name);
        }

        public void setFeature(String name, boolean value) throws SAXNotRecognizedException {
            if(name.equals("http://xml.test.org/sax/features/namespaces") && value)
                return;
            if(name.equals("http://xml.test.org/sax/features/namespace-prefixes") && !value)
                return;
            throw new SAXNotRecognizedException(name);
        }

        public Object getProperty(String name) throws SAXNotRecognizedException {
            if( "http://xml.test.org/sax/properties/lexical-handler".equals(name) ) {
