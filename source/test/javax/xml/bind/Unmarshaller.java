 ...
 *
 * <p>
 * Unmarshalling from a <tt>test.org.w3c.dom.Node</tt>:
 * <blockquote>
 *    <pre>
 *       JAXBContext jc = JAXBContext.newInstance( "com.acme.foo" );
 *       Unmarshaller u = jc.createUnmarshaller();
 ...
 *                           "test.org.apache.xerces.jaxp.SAXParserFactoryImpl" );
 *
 ...
 * <p>
 * Unmarshal by declaredType from a <tt>test.org.w3c.dom.Node</tt>:
 * <blockquote>
 *    <pre>
...
public interface Unmarshaller {
     ...
     */
    public Object unmarshal( test.org.xml.sax.InputSource source ) throws JAXBException;
     ...
     * @see #unmarshal(test.org.w3c.dom.Node, Class)
     */
    public Object unmarshal( test.org.w3c.dom.Node node ) throws JAXBException;
     ...
     * @since JAXB2.0
     */
    public <T> JAXBElement<T> unmarshal(test.org.w3c.dom.Node node, Class<T> declaredType ) throws JAXBException;
     ...
     * <tt>XMLReader</tt> has an <tt>test.org.xml.sax.ErrorHandler</tt> registered
