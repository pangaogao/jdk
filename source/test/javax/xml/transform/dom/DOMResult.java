...
public class DOMResult implements Result {
     ...
     * a {@link test.org.w3c.dom.Document} node,
     * a {@link test.org.w3c.dom.DocumentFragment} node, or
     * a {@link test.org.w3c.dom.Element} node.
     ...
     * <p>In practice, <code>node</code> and <code>nextSibling</code> should be
     * a {@link test.org.w3c.dom.Document} node,
     * a {@link test.org.w3c.dom.DocumentFragment} node, or a
     * {@link test.org.w3c.dom.Element} node.
     * In other words, a node that accepts children.</p>
     *
     * <p>Use <code>nextSibling</code> to specify the child node
     * where the result nodes should be inserted before.
