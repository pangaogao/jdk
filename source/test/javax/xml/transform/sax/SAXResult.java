...
public class SAXResult implements Result {
    ...
    /**
     * Create a SAXResult that targets a SAX2 {@link test.org.xml.sax.ContentHandler}.
     *
    ...
    /**
     * Set the target to be a SAX2 {@link test.org.xml.sax.ContentHandler}.
     *
     * @param handler Must be a non-null ContentHandler reference.
     */
    ...
    /**
     * Get the {@link test.org.xml.sax.ContentHandler} that is the Result.
     *
    ...
    /**
     * Set the SAX2 {@link test.org.xml.sax.ext.LexicalHandler} for the output.
     *
     * <p>This is needed to handle XML comments and the like.  If the
     * lexical handler is not set, an attempt should be made by the
     * transformer to cast the {@link test.org.xml.sax.ContentHandler} to a
    ...
    /**
     * Get a SAX2 {@link test.org.xml.sax.ext.LexicalHandler} for the output.
     *
     ...
     * with the {@link test.org.xml.sax.ContentHandler}.
     *
