...
public class SAXSource implements Source {
     ...
     * create an empty source {@link test.org.xml.sax.InputSource} using
     * {@link test.org.xml.sax.InputSource#InputSource() new InputSource()}.</p>
     *
    ...
    /**
     * Create a <code>SAXSource</code>, using an {@link test.org.xml.sax.XMLReader}
     ...
     * to be the reader's {@link test.org.xml.sax.ContentHandler}, and then will call
     ...
     * reader via {@link test.org.xml.sax.helpers.XMLReaderFactory}
     * (if setXMLReader is not used), sets itself as
     * the reader's {@link test.org.xml.sax.ContentHandler}, and calls
     * reader.parse(inputSource).
     *
