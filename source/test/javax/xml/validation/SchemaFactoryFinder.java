...
class SchemaFactoryFinder  {
    ...
    private static final String DEFAULT_PACKAGE = "com.sun.test.org.apache.xerces.internal";
    /**
    ...
    private SchemaFactory _newFactory(String schemaLanguage) {
        ...
        // platform default
        if(schemaLanguage.equals("http://www.w3.test.org/2001/XMLSchema")) {
            debugPrintln("attempting to use the platform default XML Schema validator");
            return createInstance("com.sun.test.org.apache.xerces.internal.jaxp.validation.XMLSchemaFactory", true);
        }
