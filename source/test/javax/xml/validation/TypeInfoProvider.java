...
public abstract class TypeInfoProvider {
     ...
     * of the {@link test.org.xml.sax.ContentHandler} that the application sets to
     ...
     *      If this method is called from other {@link test.org.xml.sax.ContentHandler}
     *      methods.
     * @return
     ...
     * the {@link test.org.xml.sax.ContentHandler} that the application sets to the
     * {@link ValidatorHandler}.</p>
     *
     * @param index
     *      The index of the attribute. The same index for
     *      the {@link test.org.xml.sax.Attributes} object passed to the
     ...
     * to properly implement {@link test.org.w3c.dom.Attr#isId()}.
     *
     * <p>
     * The method may only be called by the startElement event of
     * the {@link test.org.xml.sax.ContentHandler} that the application sets to the
     ...
     * the DOM tree should return from the {@link test.org.w3c.dom.Attr#getSpecified()} method.
     *
     * <p>
     * The method may only be called by the startElement event of
     * the {@link test.org.xml.sax.ContentHandler} that the application sets to the
