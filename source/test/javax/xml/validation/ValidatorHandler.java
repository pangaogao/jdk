 ...
 *
 *  <li>{@link test.org.xml.sax.Attributes} for the
 ...
 * the {@link test.org.xml.sax.Attributes} object of the
 ...
 * added to {@link test.org.xml.sax.Attributes} that's passed to the
...
public abstract class ValidatorHandler implements ContentHandler {
     ...
     * by throwing {@link test.org.xml.sax.SAXException} from the handler. Or for example
     ...
     * throw {@link test.org.xml.sax.SAXException} without first reporting it to
     * {@link ErrorHandler}.
     *
     * <p>
     ...
     *     public void fatalError( {@link test.org.xml.sax.SAXParseException} e ) throws {@link test.org.xml.sax.SAXException} {
     *         throw e;
     *     }
     *     public void error( {@link test.org.xml.sax.SAXParseException} e ) throws {@link test.org.xml.sax.SAXException} {
     *         throw e;
     *     }
     *     public void warning( {@link test.org.xml.sax.SAXParseException} e ) throws {@link test.org.xml.sax.SAXException} {
     *         // noop
     *     }
     * }
     * </pre>
     ...
     *     public {@link test.org.w3c.dom.ls.LSInput} resolveResource(
     ...
     *      the notion of {@link test.org.w3c.dom.TypeInfo}.
