...
public class RMIConnector implements JMXConnector, Serializable, JMXAddressable {
     ...
     * referenced object (an {@link test.org.omg.CORBA.ORB ORB}) is used to
     * connect the stub. Otherwise, a new test.org.omg.CORBA.ORB is created
     * by calling {@link
     * test.org.omg.CORBA.ORB#init(String[], Properties)
     * test.org.omg.CORBA.ORB.init((String[])null,(Properties)null)}</li>
     ...
     *      does not point to an {@link test.org.omg.CORBA.ORB ORB}.
     ...
     * the "java.naming.corba.orb" property. If it is found, the
     * referenced object (an {@link test.org.omg.CORBA.ORB ORB}) is
     * returned. Otherwise, a new test.org.omg.CORBA.ORB is created
     * by calling {@link
     * test.org.omg.CORBA.ORB#init(String[], java.util.Properties)
     * test.org.omg.CORBA.ORB.init((String[])null,(Properties)null)}
        ...
        if (environment != null) {
            ...
            if (orb != null && !(IIOPHelper.isOrb(orb)))
                throw new IllegalArgumentException(EnvHelp.DEFAULT_ORB +
                        " must be an instance of test.org.omg.CORBA.ORB.");
    ...
    /*
       ...
       test.org.omg.CORBA_2_3.portable.OutputStream for each request, and
       writes the parameters to it.  Then it calls
       _invoke(OutputStream) which it inherits from CORBA's
       ObjectImpl.  That returns an
       test.org.omg.CORBA_2_3.portable.InputStream.  The return value is
       ...
       test.org.omg.CORBA.portable.Delegate that simply forwards every
       ...
       compiled using javac -g:none.
        ...
        import test.org.omg.stub.javax.management.remote.rmi._RMIConnection_Stub;
        ...
        public class PInputStream extends ProxyInputStream {
            public PInputStream(test.org.omg.CORBA.portable.InputStream in) {
                super(in);
            }

            public test.org.omg.CORBA.Any read_any() {
                return in.read_any();
            }
    ...
    static {
        final String proxyStubByteCodeString =
                ...
                "PInputStream\14\0\20\0\21\14\0\15\0\27\1\0+test.org/omg/CORBA/porta"+
                "ble/ApplicationException\14\0%\0&\14\0'\0(\14\0\15\0)\14\0*\0&"+
                "\14\0\26\0\27\1\0*com/sun/jmx/remote/protocol/iiop/ProxyStub\1"+
                "\0<test.org/omg/stub/javax/management/remote/rmi/_RMIConnection_Stu"+
                "b\1\0)test.org/omg/CORBA/portable/RemarshalException\1\0\16getInput"+
        ...
        final String pInputStreamByteCodeString =
                ...
                "le/InputStream;\1\0\"test.org/omg/CORBA/portable/InputStream\1\0\6n"+
                "arrow\1\0*()Lorg/omg/CORBA_2_3/portable/InputStream;\1\0&test.org/o"+
  ...
  private static RMIConnection shadowIiopStub(Object stub)
    ...
    /**
     * A static WeakReference to an {@link test.org.omg.CORBA.ORB ORB} to
