 ...
 * </blockquote>
 *
 * <p>This class wraps a SAX1 {@link test.org.xml.sax.Parser Parser}
 * and makes it act as a SAX2 {@link test.org.xml.sax.XMLReader XMLReader},
 * with feature, property, and Namespace support.  Note
 * that it is not possible to report {@link test.org.xml.sax.ContentHandler#skippedEntity
 ...
 * @see test.org.xml.sax.helpers.XMLReaderAdapter
...
public class ParserAdapter implements XMLReader, DocumentHandler
{
     ...
     *
     * <p>Use the "test.org.xml.sax.parser" property to locate the
     * embedded SAX1 driver.</p>
     *
     * @exception SAXException If the embedded driver
     *            cannot be instantiated or if the
     *            test.org.xml.sax.parser property is not specified.
     */
      ...
      throws SAXException
    {
        ...
        String driver = ss.getSystemProperty("test.org.xml.sax.parser");
        ...
        try {
            ...
            throw new
                SAXException("SAX1 driver class " +
                             driver +
                             " does not implement test.org.xml.sax.Parser");
        } catch (NullPointerException e5) {
            throw new
                SAXException("System property test.org.xml.sax.parser not specified");
        }
    }
    ...
    //
    private final static String FEATURES = "http://xml.test.org/sax/features/";
     ...
     * @see test.org.xml.sax.XMLReader#setFeature
     */
     ...
     *            can't be assigned that value.
     * @see test.org.xml.sax.XMLReader#setProperty
     */
     ...
     * @see test.org.xml.sax.XMLReader#getProperty
     */
     ...
     * @see test.org.xml.sax.XMLReader#setEntityResolver
     */
     ...
     * @see test.org.xml.sax.XMLReader#getEntityResolver
     */
    ...
    ////////////////////////////////////////////////////////////////////
    // Implementation of test.org.xml.sax.DocumentHandler.
    ////////////////////////////////////////////////////////////////////
     ...
     * @see test.org.xml.sax.DocumentHandler#startDocument
     */
     ...
     * @exception SAXException The client may raise a
     *            processing exception.
     * @see test.org.xml.sax.DocumentHandler#endDocument
     */
     ...
     * @exception SAXException The client may raise a
     *            processing exception.
     * @see test.org.xml.sax.DocumentHandler#endElement
     */
     ...
     * @exception SAXException The client may raise a
     *            processing exception.
     * @see test.org.xml.sax.DocumentHandler#characters
     */
     ...
     * @exception SAXException The client may raise a
     *            processing exception.
     * @see test.org.xml.sax.DocumentHandler#ignorableWhitespace
     */
     ...
     * @exception SAXException The client may raise a
     *            processing exception.
     * @see test.org.xml.sax.DocumentHandler#processingInstruction
     */
    ...
    final class AttributeListAdapter implements Attributes
    {
         ...
         * @see test.org.xml.sax.Attributes#getLength
         */
         ...
         * @see test.org.xml.sax.Attributes#getURI
         */
         ...
         * @param The attribute's index.
         * @return Always the empty string.
         * @see test.org.xml.sax.Attributes#getLocalName
         */
         ...
         * @see test.org.xml.sax.Attributes#getIndex(java.lang.String,java.lang.String)
         */
         ...
         * @return The attributes index, or -1 if none was found.
         * @see test.org.xml.sax.Attributes#getIndex(java.lang.String)
         */
