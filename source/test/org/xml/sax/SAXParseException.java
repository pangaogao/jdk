 ...
 * in the {@link test.org.xml.sax.ErrorHandler ErrorHandler} interface,
 * the application is not actually required to throw the exception;
 * instead, it can simply read the information in it and take a
 * different action.</p>
 *
 * <p>Since this exception is a subclass of {@link test.org.xml.sax.SAXException
...
public class SAXParseException extends SAXException {
     ...
     * creating its own exception from within a {@link test.org.xml.sax.ContentHandler
     ...
     * subclass of {@link test.org.xml.sax.SAXException SAXException}.</p>
     *
     ...
     * {@link test.org.xml.sax.SAXException SAXException}.</p>
     *
