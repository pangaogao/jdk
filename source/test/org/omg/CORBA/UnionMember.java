 ...
 */
/*
 * File: ./test.org/omg/CORBA/UnionMember.java
 * From: ./ir.idl
 ...
 */
public final class UnionMember implements test.org.omg.CORBA.portable.IDLEntity {
    //  instance variables
     ...
     * @serial
     */
    public test.org.omg.CORBA.Any label;
     ...
     * @serial
     */
    public test.org.omg.CORBA.IDLType type_def;
     ...
     */
    public UnionMember(String __name, test.org.omg.CORBA.Any __label, test.org.omg.CORBA.TypeCode __type, test.org.omg.CORBA.IDLType __type_def) {
        name = __name;
        label = __label;
        type = __type;
        type_def = __type_def;
