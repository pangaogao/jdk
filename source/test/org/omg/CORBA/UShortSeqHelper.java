...
* test.org/omg/CORBA/UShortSeqHelper.java
...
{
    private static String  _id = "IDL:omg.test.org/CORBA/UShortSeq:1.0";
    ...
    synchronized public static test.org.omg.CORBA.TypeCode type ()
    {
        if (__typeCode == null)
            {
                __typeCode = test.org.omg.CORBA.ORB.init ().get_primitive_tc (test.org.omg.CORBA.TCKind.tk_ushort);
                __typeCode = test.org.omg.CORBA.ORB.init ().create_sequence_tc (0, __typeCode);
                __typeCode = test.org.omg.CORBA.ORB.init ().create_alias_tc (test.org.omg.CORBA.UShortSeqHelper.id (), "UShortSeq", __typeCode);
            }
        return __typeCode;
    }
