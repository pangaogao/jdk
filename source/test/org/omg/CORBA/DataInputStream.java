...
* @see test.org.omg.CORBA.DataOutputStream
* @see test.org.omg.CORBA.CustomMarshal
*/
public interface DataInputStream extends test.org.omg.CORBA.portable.ValueBase
{
    /** Reads an IDL <code>Any</code> value from the input stream.
    * @return  the <code>Any</code> read.
    * @throws <code>test.org.omg.CORBA.MARSHAL</code>
    ...
    */
    test.org.omg.CORBA.Any read_any ();
    ...
    * a streaming policy, then the standard system exception MARSHAL is raised.
    */
    test.org.omg.CORBA.Object read_Object ();
    ...
    * a streaming policy, then the standard system exception MARSHAL is raised.
    */
    test.org.omg.CORBA.TypeCode read_TypeCode ();
    ...
    * a streaming policy, then the standard system exception MARSHAL is raised.
    */
    void read_any_array (test.org.omg.CORBA.AnySeqHolder seq, int offset, int length);
    ...
    * a streaming policy, then the standard system exception MARSHAL is raised.
    */
    void read_boolean_array (test.org.omg.CORBA.BooleanSeqHolder seq, int offset, int length);
    ...
    * a streaming policy, then the standard system exception MARSHAL is raised.
    */
    void read_char_array (test.org.omg.CORBA.CharSeqHolder seq, int offset, int length);
    ...
    * a streaming policy, then the standard system exception MARSHAL is raised.
    */
    void read_wchar_array (test.org.omg.CORBA.WCharSeqHolder seq, int offset, int length);
    ...
    * a streaming policy, then the standard system exception MARSHAL is raised.
    */
    void read_octet_array (test.org.omg.CORBA.OctetSeqHolder seq, int offset, int length);
    ...
    * a streaming policy, then the standard system exception MARSHAL is raised.
    */
    void read_short_array (test.org.omg.CORBA.ShortSeqHolder seq, int offset, int length);
    ...
    * a streaming policy, then the standard system exception MARSHAL is raised.
    */
    void read_ushort_array (test.org.omg.CORBA.UShortSeqHolder seq, int offset, int length);
    ...
    * a streaming policy, then the standard system exception MARSHAL is raised.
    */
    void read_long_array (test.org.omg.CORBA.LongSeqHolder seq, int offset, int length);
    ...
    * a streaming policy, then the standard system exception MARSHAL is raised.
    */
    void read_ulong_array (test.org.omg.CORBA.ULongSeqHolder seq, int offset, int length);
    ...
    * a streaming policy, then the standard system exception MARSHAL is raised.
    */
    void read_ulonglong_array (test.org.omg.CORBA.ULongLongSeqHolder seq, int offset, int length);
    ...
    * a streaming policy, then the standard system exception MARSHAL is raised.
    */
    void read_longlong_array (test.org.omg.CORBA.LongLongSeqHolder seq, int offset, int length);
    ...
    * a streaming policy, then the standard system exception MARSHAL is raised.
    */
    void read_float_array (test.org.omg.CORBA.FloatSeqHolder seq, int offset, int length);
    ...
    * a streaming policy, then the standard system exception MARSHAL is raised.
    */
    void read_double_array (test.org.omg.CORBA.DoubleSeqHolder seq, int offset, int length);
