...
* test.org/omg/CORBA/StructMemberHelper.java
...
{
  private static String  _id = "IDL:omg.test.org/CORBA/StructMember:1.0";

  public static void insert (test.org.omg.CORBA.Any a, test.org.omg.CORBA.StructMember that)
  {
  ...
  public static test.org.omg.CORBA.StructMember extract (test.org.omg.CORBA.Any a)
  {
    ...
    if (__typeCode == null)
    {
      synchronized (test.org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          __active = true;
          test.org.omg.CORBA.StructMember[] _members0 = new test.org.omg.CORBA.StructMember [3];
          ...
          _members0[2] = new test.org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = test.org.omg.CORBA.ORB.init ().create_struct_tc (test.org.omg.CORBA.StructMemberHelper.id (), "StructMember", _members0);
          __active = false;
        }
      }
    }
  ...
  public static test.org.omg.CORBA.StructMember read (test.org.omg.CORBA.portable.InputStream istream)
  {
    test.org.omg.CORBA.StructMember value = new test.org.omg.CORBA.StructMember ();
  ...
  public static void write (test.org.omg.CORBA.portable.OutputStream ostream, test.org.omg.CORBA.StructMember value)
  {
