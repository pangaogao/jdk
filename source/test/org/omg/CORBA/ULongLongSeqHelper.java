...
* test.org/omg/CORBA/ULongLongSeqHelper.java
...
{
    private static String  _id = "IDL:omg.test.org/CORBA/ULongLongSeq:1.0";

    public static void insert (test.org.omg.CORBA.Any a, long[] that)
    {
    ...
    public static long[] extract (test.org.omg.CORBA.Any a)
    {
    ...
    synchronized public static test.org.omg.CORBA.TypeCode type ()
    {
        if (__typeCode == null)
            {
                __typeCode = test.org.omg.CORBA.ORB.init ().get_primitive_tc (test.org.omg.CORBA.TCKind.tk_ulonglong);
                __typeCode = test.org.omg.CORBA.ORB.init ().create_sequence_tc (0, __typeCode);
                __typeCode = test.org.omg.CORBA.ORB.init ().create_alias_tc (test.org.omg.CORBA.ULongLongSeqHelper.id (), "ULongLongSeq", __typeCode);
            }
        return __typeCode;
    }
    ...
    public static long[] read (test.org.omg.CORBA.portable.InputStream istream)
    {
        long value[] = null;
    ...
    public static void write (test.org.omg.CORBA.portable.OutputStream ostream, long[] value)
    {
