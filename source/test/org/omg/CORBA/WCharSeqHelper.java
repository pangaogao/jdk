...
* test.org/omg/CORBA/WCharSeqHelper.java
...
{
    private static String  _id = "IDL:omg.test.org/CORBA/WCharSeq:1.0";

    public static void insert (test.org.omg.CORBA.Any a, char[] that)
    {
    ...
    public static char[] extract (test.org.omg.CORBA.Any a)
    {
    ...
    synchronized public static test.org.omg.CORBA.TypeCode type ()
    {
        if (__typeCode == null)
            {
                __typeCode = test.org.omg.CORBA.ORB.init ().get_primitive_tc (test.org.omg.CORBA.TCKind.tk_wchar);
                __typeCode = test.org.omg.CORBA.ORB.init ().create_sequence_tc (0, __typeCode);
                __typeCode = test.org.omg.CORBA.ORB.init ().create_alias_tc (test.org.omg.CORBA.WCharSeqHelper.id (), "WCharSeq", __typeCode);
            }
        return __typeCode;
    }
    ...
    public static char[] read (test.org.omg.CORBA.portable.InputStream istream)
    {
        char value[] = null;
    ...
    public static void write (test.org.omg.CORBA.portable.OutputStream ostream, char[] value)
    {
