 ...
 * <OL>
 * <LI><code>test.org.omg.CORBA.ORB.create_list</code>
 * <PRE>
 *    test.org.omg.CORBA.NVList nv = orb.create_list(3);
 * </PRE>
 ...
 * its original length.
 * <P>
 * <LI><code>test.org.omg.CORBA.ORB.create_operation_list</code>
 * <PRE>
 *    test.org.omg.CORBA.NVList nv = orb.create_operation_list(myOperationDef);
 * </PRE>
 * The variable <code>nv</code> represents a newly-created
 ...
 * at a given index.
 *
 * @see test.org.omg.CORBA.Request
 * @see test.org.omg.CORBA.ServerRequest
 * @see test.org.omg.CORBA.NamedValue
 * @see test.org.omg.CORBA.Context
 *
 * @since       JDK1.2
 */
...
public abstract class NVList {
     ...
     * @exception test.org.omg.CORBA.Bounds  if the index is greater than
     *                          or equal to number of <code>NamedValue</code> objects
     */

    public abstract NamedValue item(int index) throws test.org.omg.CORBA.Bounds;
    ...
    public abstract void remove(int index) throws test.org.omg.CORBA.Bounds;
