...
abstract public class Any implements IDLEntity {
     ...
     *
     * @param is the <code>test.org.omg.CORBA.portable.InputStream</code>
     ...
     *
     * @param os        the <code>test.org.omg.CORBA.portable.OutputStream</code>
    ...
    /**
     * Extracts the <code>test.org.omg.CORBA.Object</code> in this
     * <code>Any</code> object's <code>value</code> field.
     *
     * @return the <code>test.org.omg.CORBA.Object</code> stored in
     *         this <code>Any</code> object
     * @exception BAD_OPERATION if this  <code>Any</code> object
     *              contains something other than an
     *              <code>test.org.omg.CORBA.Object</code> or the
     *              <code>value</code> field has not yet been set
     */
    abstract public test.org.omg.CORBA.Object extract_Object() throws BAD_OPERATION;

    /**
     * Inserts the given <code>test.org.omg.CORBA.Object</code> object
     * into this <code>Any</code> object's <code>value</code> field.
     *
     * @param o         the <code>test.org.omg.CORBA.Object</code> object to insert into this
     *                <code>Any</code> object
     */
    abstract public void insert_Object(test.org.omg.CORBA.Object o);
...
/**
     ...
     * into this <code>Any</code> object's <code>value</code> field.
     *
     * @param o         the <code>test.org.omg.CORBA.Object</code> instance to insert into this
     *                <code>Any</code> object
     * @param t     the <code>TypeCode</code> object that is to be inserted into
     ...
     *
     */
    abstract public void insert_Object(test.org.omg.CORBA.Object o, TypeCode t)
        throws BAD_PARAM;
     ...
     *      comments for unimplemented features</a>
     */
    public test.org.omg.CORBA.portable.Streamable extract_Streamable()
        throws test.org.omg.CORBA.BAD_INV_ORDER {
        throw new test.org.omg.CORBA.NO_IMPLEMENT() ;
    }
     ...
     * <code>test.org.omg.CORBA.NO_IMPLEMENT</code></a> exception.
     * <P>
     ...
     *              object being inserted
     * @throws test.org.omg.CORBA.BAD_INV_ORDER if this method is  invoked improperly
     * @see <a href="package-summary.html#unimpl"><code>CORBA</code> package
     *      comments for unimplemented features</a>
     */
