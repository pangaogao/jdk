...
* test.org/omg/CORBA/ShortSeqHelper.java
...
{
    private static String  _id = "IDL:omg.test.org/CORBA/ShortSeq:1.0";
        ...
        if (__typeCode == null)
            {
                ...
                __typeCode = test.org.omg.CORBA.ORB.init ().create_alias_tc (test.org.omg.CORBA.ShortSeqHelper.id (), "ShortSeq", __typeCode);
            }
        return __typeCode;
    }
