...
* test.org/omg/CORBA/DefinitionKindHelper.java
...
{
  private static String  _id = "IDL:omg.test.org/CORBA/DefinitionKind:1.0";

  public static void insert (test.org.omg.CORBA.Any a, test.org.omg.CORBA.DefinitionKind that)
  {
  ...
  public static test.org.omg.CORBA.DefinitionKind extract (test.org.omg.CORBA.Any a)
  {
  ...
  public static test.org.omg.CORBA.DefinitionKind read (test.org.omg.CORBA.portable.InputStream istream)
  {
    return test.org.omg.CORBA.DefinitionKind.from_int (istream.read_long ());
  }

  public static void write (test.org.omg.CORBA.portable.OutputStream ostream, test.org.omg.CORBA.DefinitionKind value)
  {
