...
import test.org.omg.CORBA.TypeCodePackage.*;
 ...
 * <PRE>
 *   test.org.omg.CORBA.TypeCode tcString = orb.create_string_tc(30);
 * </PRE>
 * <P> The following creates a <code>TypeCode</code>
 * object for an <code>array</code> of five <code>string</code>s:
 * <PRE>
 *   test.org.omg.CORBA.TypeCode tcArray = orb.create_array_tc(
 *                                       5, TCKind.tk_string);
 * </PRE>
 * <P> The following creates a <code>TypeCode</code>
 * object for an interface named "Account":
 * <PRE>
 *   test.org.omg.CORBA.TypeCode tcInterface = orb.create_interface_tc(
 *                                                 "thisId", "Account");
 * </PRE>
...
public abstract class TypeCode implements IDLEntity {
     ...
     * @throws test.org.omg.CORBA.TypeCodePackage.BadKind if the method
     ...
     * @throws test.org.omg.CORBA.TypeCodePackage.Bounds if the index is equal
     *            to or greater than
     ...
     * @throws test.org.omg.CORBA.TypeCodePackage.Bounds if the index is
     ...
     * @throws test.org.omg.CORBA.TypeCodePackage.BadKind if this method
     *           is invoked on an inappropriate kind of <code>TypeCode</code>
     *           object
         *
     */
     ...
     *           object
     * @throws test.org.omg.CORBA.TypeCodePackage.Bounds
     ...
     * @throws test.org.omg.CORBA.TypeCodePackage.BadKind
     *           if this method
     *           is invoked on a non-value type <code>TypeCode</code>
     *           object
     * @see <a href="package-summary.html#unimpl"><code>CORBA</code> package
