...
public final class ServiceInformationHolder
    implements test.org.omg.CORBA.portable.Streamable {
     ...
     */
    public ServiceInformationHolder(test.org.omg.CORBA.ServiceInformation arg) {
        value = arg;
    }
     ...
     */
    public void _write(test.org.omg.CORBA.portable.OutputStream out) {
        test.org.omg.CORBA.ServiceInformationHelper.write(out, value);
    }
     ...
     */
    public void _read(test.org.omg.CORBA.portable.InputStream in) {
        value = test.org.omg.CORBA.ServiceInformationHelper.read(in);
    }
    ...
    public test.org.omg.CORBA.TypeCode _type() {
        return test.org.omg.CORBA.ServiceInformationHelper.type();
    }
}
