 ...
 */
@Deprecated
public interface DynFixed extends test.org.omg.CORBA.Object, test.org.omg.CORBA.DynAny
{
    /**
     ...
     * @param val the value of the fixed type as a byte array
         * @throws test.org.omg.CORBA.DynAnyPackage.InvalidValue if the given
         *         argument is bad
         * @see #get_value
     */
