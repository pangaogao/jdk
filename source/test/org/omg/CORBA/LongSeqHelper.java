...
* test.org/omg/CORBA/LongSeqHelper.java
...
{
    private static String  _id = "IDL:omg.test.org/CORBA/LongSeq:1.0";
        ...
        if (__typeCode == null)
            {
                ...
                __typeCode = test.org.omg.CORBA.ORB.init ().create_alias_tc (test.org.omg.CORBA.LongSeqHelper.id (), "LongSeq", __typeCode);
            }
        return __typeCode;
    }
