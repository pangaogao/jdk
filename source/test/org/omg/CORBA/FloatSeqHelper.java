...
* test.org/omg/CORBA/FloatSeqHelper.java
...
{
    private static String  _id = "IDL:omg.test.org/CORBA/FloatSeq:1.0";

    public static void insert (test.org.omg.CORBA.Any a, float[] that)
    {
    ...
    public static float[] extract (test.org.omg.CORBA.Any a)
    {
    ...
    synchronized public static test.org.omg.CORBA.TypeCode type ()
    {
        if (__typeCode == null)
            {
                __typeCode = test.org.omg.CORBA.ORB.init ().get_primitive_tc (test.org.omg.CORBA.TCKind.tk_float);
                __typeCode = test.org.omg.CORBA.ORB.init ().create_sequence_tc (0, __typeCode);
                __typeCode = test.org.omg.CORBA.ORB.init ().create_alias_tc (test.org.omg.CORBA.FloatSeqHelper.id (), "FloatSeq", __typeCode);
            }
        return __typeCode;
    }
    ...
    public static float[] read (test.org.omg.CORBA.portable.InputStream istream)
    {
        float value[] = null;
    ...
    public static void write (test.org.omg.CORBA.portable.OutputStream ostream, float[] value)
    {
