 ...
 *
 * @see test.org.omg.CORBA.DynamicImplementation
 * @see test.org.omg.CORBA.NVList
...
public abstract class ServerRequest {
    ...
    /**
     * Throws an <code>test.org.omg.CORBA.NO_IMPLEMENT</code> exception.
     * <P>
     * Retrieves the name of the operation being
     * invoked. According to OMG IDL's rules, these names must be unique
     * among all operations supported by this object's "most-derived"
     ...
     *      package comments for unimplemented features</a>
     */
    public void arguments(test.org.omg.CORBA.NVList args) {
        throw new test.org.omg.CORBA.NO_IMPLEMENT();
    }
     ...
     *      package comments for unimplemented features</a>
     */
    public void set_result(test.org.omg.CORBA.Any any)
    {
        throw new test.org.omg.CORBA.NO_IMPLEMENT();
    }
