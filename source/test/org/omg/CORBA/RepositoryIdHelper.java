...
* test.org/omg/CORBA/RepositoryIdHelper.java
...
{
  private static String  _id = "IDL:omg.test.org/CORBA/RepositoryId:1.0";
  ...
  synchronized public static test.org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = test.org.omg.CORBA.ORB.init ().create_alias_tc (test.org.omg.CORBA.RepositoryIdHelper.id (), "RepositoryId", __typeCode);
    }
    return __typeCode;
  }
