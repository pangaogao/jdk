...
/**
* test.org/omg/CORBA/StringSeqHolder.java .
...
/** An array of Strings */
public final class StringSeqHolder implements test.org.omg.CORBA.portable.Streamable
{
  ...
  {
    value = test.org.omg.CORBA.StringSeqHelper.read (i);
  }

  public void _write (test.org.omg.CORBA.portable.OutputStream o)
  {
    test.org.omg.CORBA.StringSeqHelper.write (o, value);
  }

  public test.org.omg.CORBA.TypeCode _type ()
  {
    return test.org.omg.CORBA.StringSeqHelper.type ();
  }
