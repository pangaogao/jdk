 ...
 *    String s = "argument_1";
 *    test.org.omg.CORBA.Any myAny = orb.create_any();
 *    myAny.insert_long(12345);
 *    int in = test.org.omg.CORBA.ARG_IN.value;

 *    test.org.omg.CORBA.NamedValue nv = orb.create_named_value(
 *        s, myAny, in);
 ...
 *    } catch (test.org.omg.CORBA.BAD_OPERATION b) {
