...
public final class NameValuePair implements test.org.omg.CORBA.portable.IDLEntity {
     ...
     */
    public test.org.omg.CORBA.Any value;
     ...
     * the given name with the given <code>test.org.omg.CORBA.Any</code> object.
     ...
     */
    public NameValuePair(String __id, test.org.omg.CORBA.Any __value) {
        id = __id;
        value = __value;
    }
}
