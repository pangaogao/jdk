...
/*
 * File: ./test.org/omg/CORBA/DefinitionKind.java
 * From: ./ir.idl
...
public class DefinitionKind implements test.org.omg.CORBA.portable.IDLEntity {
...
.
     * @param i one of the <code>int</code> constants from the class
         ...
         *         to the given code
         * @throws test.org.omg.CORBA.BAD_PARAM if the given parameter is not
 one
