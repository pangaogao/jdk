 ...
 *  method.
 */
public final class ServiceInformation implements test.org.omg.CORBA.portable.IDLEntity
{
    ...
    */
    public test.org.omg.CORBA.ServiceDetail[] service_details;
    ...
    */
    public ServiceInformation(int[] __service_options,
                              test.org.omg.CORBA.ServiceDetail[] __service_details)
    {
