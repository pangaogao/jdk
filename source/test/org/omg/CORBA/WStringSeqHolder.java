...
/**
* test.org/omg/CORBA/WStringSeqHolder.java .
...
public final class WStringSeqHolder implements test.org.omg.CORBA.portable.Streamable
{
  ...
  {
    value = test.org.omg.CORBA.WStringSeqHelper.read (i);
  }

  public void _write (test.org.omg.CORBA.portable.OutputStream o)
  {
    test.org.omg.CORBA.WStringSeqHelper.write (o, value);
  }

  public test.org.omg.CORBA.TypeCode _type ()
  {
    return test.org.omg.CORBA.WStringSeqHelper.type ();
  }
