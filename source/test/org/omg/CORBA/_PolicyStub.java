...
* test.org/omg/CORBA/_PolicyStub.java
* Generated by the IDL-to-Java compiler (portable), version "3.0"
* from ../../../../../src/share/classes/test.org/omg/PortableServer/corba.idl.
* Saturday, July 17, 1999 12:26:20 AM PDT
*/

public class _PolicyStub extends test.org.omg.CORBA.portable.ObjectImpl implements test.org.omg.CORBA.Policy
{
  /** Constructors
   ...
   */
  public _PolicyStub (test.org.omg.CORBA.portable.Delegate delegate)
  {
    super ();
  ...
  /** Returns the constant value that corresponds to the
                ...
                * sending mail to request@omg.test.org.  In general the constant
  ...
  public int policy_type ()
  {
    ...
    try {
       test.org.omg.CORBA.portable.OutputStream _out = _request ("_get_policy_type", true);
       _in = _invoke (_out);
       int __result = test.org.omg.CORBA.PolicyTypeHelper.read (_in);
       return __result;
  ...
  public test.org.omg.CORBA.Policy copy ()
  {
    test.org.omg.CORBA.portable.InputStream _in = null;
    try {
       test.org.omg.CORBA.portable.OutputStream _out = _request ("copy", true);
       _in = _invoke (_out);
       test.org.omg.CORBA.Policy __result = test.org.omg.CORBA.PolicyHelper.read (_in);
       return __result;
    } catch (test.org.omg.CORBA.portable.ApplicationException _ex) {
       _in = _ex.getInputStream ();
       String _id = _ex.getId ();
  ...
  private static String[] __ids = {
    "IDL:omg.test.org/CORBA/Policy:1.0"};
