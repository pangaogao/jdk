...
* test.org/omg/CORBA/VersionSpecHelper.java
...
{
  private static String  _id = "IDL:omg.test.org/CORBA/VersionSpec:1.0";
  ...
  synchronized public static test.org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = test.org.omg.CORBA.ORB.init ().create_alias_tc (test.org.omg.CORBA.VersionSpecHelper.id (), "VersionSpec", __typeCode);
    }
    return __typeCode;
  }
