...
* test.org/omg/CORBA/StringValueHelper.java
...
public class StringValueHelper implements test.org.omg.CORBA.portable.BoxedValueHelper
{
    private static String  _id = "IDL:omg.test.org/CORBA/StringValue:1.0";
                        ...
                        if (__typeCode == null)
                            {
                                ...
                                __typeCode = test.org.omg.CORBA.ORB.init ().create_value_box_tc (_id, "StringValue", __typeCode);
                                __active = false;
                            }
                    }
            }
