...
* test.org/omg/CORBA/IdentifierHelper.java
...
{
  private static String  _id = "IDL:omg.test.org/CORBA/Identifier:1.0";
  ...
  synchronized public static test.org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = test.org.omg.CORBA.ORB.init ().create_alias_tc (test.org.omg.CORBA.IdentifierHelper.id (), "Identifier", __typeCode);
    }
    return __typeCode;
  }
