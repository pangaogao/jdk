...
* @see test.org.omg.CORBA.DataInputStream
* @see test.org.omg.CORBA.CustomMarshal
*/
public interface DataOutputStream extends test.org.omg.CORBA.portable.ValueBase
{
    /**
    * Writes the Any value to the output stream.
    * @param value The value to be written.
    */
    void write_any (test.org.omg.CORBA.Any value);
    ...
    * @param value The value to be written.
    */
    void write_Object (test.org.omg.CORBA.Object value);
    ...
    * @param value The value to be written.
    */
    void write_TypeCode (test.org.omg.CORBA.TypeCode value);
    ...
    */
    void write_any_array (test.org.omg.CORBA.Any[] seq, int offset, int length);
