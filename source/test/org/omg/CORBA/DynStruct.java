 ...
 */
@Deprecated
public interface DynStruct extends test.org.omg.CORBA.Object, test.org.omg.CORBA.DynAny
{
    /**
     ...
     */
    public test.org.omg.CORBA.TCKind current_member_kind();
     ...
     * @return the array of name-value pairs
         * @see #set_members
     */
    public test.org.omg.CORBA.NameValuePair[] get_members();

    /**
     * Set the members of the struct.
     *
     * @param value the array of name-value pairs.
         * @throws test.org.omg.CORBA.DynAnyPackage.InvalidSeq if the given argument
         *         is invalid
         * @see #get_members
     */
    public void set_members(test.org.omg.CORBA.NameValuePair[] value)
