...
* test.org/omg/CORBA/CharSeqHelper.java
...
{
    private static String  _id = "IDL:omg.test.org/CORBA/CharSeq:1.0";
    ...
    synchronized public static test.org.omg.CORBA.TypeCode type ()
    {
        if (__typeCode == null)
            {
                __typeCode = test.org.omg.CORBA.ORB.init ().get_primitive_tc (test.org.omg.CORBA.TCKind.tk_char);
                __typeCode = test.org.omg.CORBA.ORB.init ().create_sequence_tc (0, __typeCode);
                __typeCode = test.org.omg.CORBA.ORB.init ().create_alias_tc (test.org.omg.CORBA.CharSeqHelper.id (), "CharSeq", __typeCode);
            }
        return __typeCode;
    }
