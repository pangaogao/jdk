...
/**
 * The test.org.omg.CORBA.portable.UnknownException is used for reporting
 ...
 * If the CORBA system exception test.org.omg.CORBA.portable.UnknownException
 * is thrown, then the stub does one of the following:
 * (1) Translates it to test.org.omg.CORBA.UNKNOWN.
 * (2) Translates it to the nested exception that the UnknownException contains.
 * (3) Passes it on directly to the user.
 */
public class UnknownException extends test.org.omg.CORBA.SystemException {
    /**
    ...
    public UnknownException(Throwable ex) {
        super("", 0, test.org.omg.CORBA.CompletionStatus.COMPLETED_MAYBE);
        originalEx = ex;
    }
}
