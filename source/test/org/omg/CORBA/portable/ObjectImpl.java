 ...
 *  of the <code>test.org.omg.CORBA.Object</code> methods. All method implementations are
...
abstract public class ObjectImpl implements test.org.omg.CORBA.Object
{
     ...
     *         <code>false</code> otherwise
     */
    public boolean _is_equivalent(test.org.omg.CORBA.Object that) {
     ...
     * object.
     *
     * @return the <code>test.org.omg.CORBA.Object</code> instance that is the
    ...
    public test.org.omg.CORBA.Object _get_interface_def()
    {
        ...
        test.org.omg.CORBA.portable.Delegate delegate = _get_delegate();
        try {
        ...
        catch( test.org.omg.CORBA.NO_IMPLEMENT ex ) {
            // Call "InterfaceDef get_interface(..)" method using reflection.
            try {
                Class[] argc = { test.org.omg.CORBA.Object.class };
                java.lang.reflect.Method meth =
                    delegate.getClass().getMethod("get_interface", argc);
                Object[] argx = { this };
                return (test.org.omg.CORBA.Object)meth.invoke(delegate, argx);
            }
     ...
     *          <code>ObjectImpl</code> object
     */
    public test.org.omg.CORBA.ORB _orb() {
     ...
     * @see test.org.omg.CORBA.PolicyOperations#policy_type
     */
    public test.org.omg.CORBA.Policy _get_policy(int policy_type) {
     ...
     */
    public test.org.omg.CORBA.DomainManager[] _get_domain_managers() {
    ...
    public test.org.omg.CORBA.Object
        _set_policy_override(test.org.omg.CORBA.Policy[] policies,
     ...
     * @throws test.org.omg.CORBA.BAD_PARAM if the servant is not the expected type
     */
