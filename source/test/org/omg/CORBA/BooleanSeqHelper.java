...
* test.org/omg/CORBA/BooleanSeqHelper.java
...
{
    private static String  _id = "IDL:omg.test.org/CORBA/BooleanSeq:1.0";

    public static void insert (test.org.omg.CORBA.Any a, boolean[] that)
    {
    ...
    public static boolean[] extract (test.org.omg.CORBA.Any a)
    {
    ...
    synchronized public static test.org.omg.CORBA.TypeCode type ()
    {
        if (__typeCode == null)
            {
                __typeCode = test.org.omg.CORBA.ORB.init ().get_primitive_tc (test.org.omg.CORBA.TCKind.tk_boolean);
                __typeCode = test.org.omg.CORBA.ORB.init ().create_sequence_tc (0, __typeCode);
                __typeCode = test.org.omg.CORBA.ORB.init ().create_alias_tc (test.org.omg.CORBA.BooleanSeqHelper.id (), "BooleanSeq", __typeCode);
            }
        return __typeCode;
    }
    ...
    public static boolean[] read (test.org.omg.CORBA.portable.InputStream istream)
    {
        boolean value[] = null;
    ...
    public static void write (test.org.omg.CORBA.portable.OutputStream ostream, boolean[] value)
    {
