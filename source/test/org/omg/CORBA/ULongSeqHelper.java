...
* test.org/omg/CORBA/ULongSeqHelper.java
...
{
    private static String  _id = "IDL:omg.test.org/CORBA/ULongSeq:1.0";
        ...
        if (__typeCode == null)
            {
                ...
                __typeCode = test.org.omg.CORBA.ORB.init ().create_alias_tc (test.org.omg.CORBA.ULongSeqHelper.id (), "ULongSeq", __typeCode);
            }
        return __typeCode;
    }
