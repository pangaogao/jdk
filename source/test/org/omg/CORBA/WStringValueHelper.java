...
/**
* test.org/omg/CORBA/WStringValueHelper.java
...
public class WStringValueHelper implements test.org.omg.CORBA.portable.BoxedValueHelper
{
    private static String  _id = "IDL:omg.test.org/CORBA/WStringValue:1.0";
  ...
  private static WStringValueHelper _instance = new WStringValueHelper ();
                        ...
                        if (__typeCode == null)
                            {
                                ...
                                __active = true;
                                __typeCode = test.org.omg.CORBA.ORB.init ().create_wstring_tc (0);
                                __typeCode = test.org.omg.CORBA.ORB.init ().create_value_box_tc (_id, "WStringValue", __typeCode);
                                __active = false;
                            }
                    }
            }
    ...
    {
    if (!(istream instanceof test.org.omg.CORBA_2_3.portable.InputStream)) {
      throw new test.org.omg.CORBA.BAD_PARAM(); }
    return (String) ((test.org.omg.CORBA_2_3.portable.InputStream) istream).read_value (_instance);
    }

  public java.io.Serializable read_value (test.org.omg.CORBA.portable.InputStream istream)
    {
    String tmp;
  ...
  public static void write (test.org.omg.CORBA.portable.OutputStream ostream, String value)
    {
    if (!(ostream instanceof test.org.omg.CORBA_2_3.portable.OutputStream)) {
      throw new test.org.omg.CORBA.BAD_PARAM(); }
    ((test.org.omg.CORBA_2_3.portable.OutputStream) ostream).write_value (value, _instance);
    }

    public void write_value (test.org.omg.CORBA.portable.OutputStream ostream, java.io.Serializable value)
    {
