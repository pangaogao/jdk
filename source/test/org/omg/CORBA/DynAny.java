...
/** Enables <tt>test.org.omg.CORBA.Any</tt> values to be dynamically
 ...
 */
@Deprecated
public interface DynAny extends test.org.omg.CORBA.Object
{
    /**
     ...
     */
    public test.org.omg.CORBA.TypeCode type() ;
     ...
     *            invalid
     */
    public void assign(test.org.omg.CORBA.DynAny dyn_any)
        throws test.org.omg.CORBA.DynAnyPackage.Invalid;
     ...
     */
    public test.org.omg.CORBA.DynAny copy() ;
     ...
     *              <code>DynAny</code> object
     * @throws test.org.omg.CORBA.DynAnyPackage.InvalidValue
    ...
    /**
     * Inserts the given <code>test.org.omg.CORBA.Object</code> as the value for this
     * <code>DynAny</code> object.
     *
     * <p> If this method is called on a constructed <code>DynAny</code>
     * object, it initializes the next component of the constructed data
     * value associated with this <code>DynAny</code> object.
     *
     * @param value the <code>test.org.omg.CORBA.Object</code> to insert into this
     *              <code>DynAny</code> object
     * @throws test.org.omg.CORBA.DynAnyPackage.InvalidValue
     *            if the value inserted is not consistent with the type
     *            of the accessed component in this <code>DynAny</code> object
    ...
    /**
     * Inserts the given <code>test.org.omg.CORBA.TypeCode</code> as the value for this
     * <code>DynAny</code> object.
     *
     * <p> If this method is called on a constructed <code>DynAny</code>
     * object, it initializes the next component of the constructed data
     * value associated with this <code>DynAny</code> object.
     *
     * @param value the <code>test.org.omg.CORBA.TypeCode</code> to insert into this
     *              <code>DynAny</code> object
     * @throws test.org.omg.CORBA.DynAnyPackage.InvalidValue
     *            if the value inserted is not consistent with the type
     *            of the accessed component in this <code>DynAny</code> object
    ...
    /**
     * Inserts the given <code>test.org.omg.CORBA.Any</code> object as the value for this
     * <code>DynAny</code> object.
     *
     * <p> If this method is called on a constructed <code>DynAny</code>
     * object, it initializes the next component of the constructed data
     * value associated with this <code>DynAny</code> object.
     *
     * @param value the <code>test.org.omg.CORBA.Any</code> object to insert into this
     *              <code>DynAny</code> object
     * @throws test.org.omg.CORBA.DynAnyPackage.InvalidValue
     *            if the value inserted is not consistent with the type
     *            of the accessed component in this <code>DynAny</code> object
     ...
     * @throws test.org.omg.CORBA.DynAnyPackage.TypeMismatch
    ...
    /**
     * Retrieves the <code>test.org.omg.CORBA.Other</code> contained
     * in this <code>DynAny</code> object.
     *
     * @return the <code>test.org.omg.CORBA.Other</code> that is the
     *         value for this <code>DynAny</code> object
     * @throws test.org.omg.CORBA.DynAnyPackage.TypeMismatch
     *               if the type code of the accessed component in this
     *               <code>DynAny</code> object is not equivalent to
     *               the type code for an <code>test.org.omg.CORBA.Other</code>
     */
    ...
    /**
     * Retrieves the <code>test.org.omg.CORBA.TypeCode</code> contained
     * in this <code>DynAny</code> object.
     *
     * @return the <code>test.org.omg.CORBA.TypeCode</code> that is the
     *         value for this <code>DynAny</code> object
     * @throws test.org.omg.CORBA.DynAnyPackage.TypeMismatch
     *               if the type code of the accessed component in this
     *               <code>DynAny</code> object is not equivalent to
     *               the type code for a <code>test.org.omg.CORBA.TypeCode</code>
     */
    ...
    /**
     * Retrieves the <code>test.org.omg.CORBA.Any</code> contained
     * in this <code>DynAny</code> object.
     *
     * @return the <code>test.org.omg.CORBA.Any</code> that is the
     *         value for this <code>DynAny</code> object
     * @throws test.org.omg.CORBA.DynAnyPackage.TypeMismatch
     *               if the type code of the accessed component in this
     *               <code>DynAny</code> object is not equivalent to
     *               the type code for an <code>test.org.omg.CORBA.Any</code>
     */
     ...
     * to extract the value of the component.
         ...
         *         accessed
     */
    public test.org.omg.CORBA.DynAny current_component() ;
