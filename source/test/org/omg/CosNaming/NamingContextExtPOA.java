...
/**
* test.org/omg/CosNaming/NamingContextExtPOA.java .
 ...
 */
public abstract class NamingContextExtPOA extends test.org.omg.PortableServer.Servant
 implements test.org.omg.CosNaming.NamingContextExtOperations, test.org.omg.CORBA.portable.InvokeHandler
{
   ...
   */
       ...
       {
         try {
           String sn = test.org.omg.CosNaming.NamingContextExtPackage.StringNameHelper.read (in);
           test.org.omg.CosNaming.NameComponent $result[] = null;
           $result = this.to_name (sn);
           out = $rh.createReply();
           test.org.omg.CosNaming.NameHelper.write (out, $result);
         } catch (test.org.omg.CosNaming.NamingContextPackage.InvalidName $ex) {
           out = $rh.createExceptionReply ();
           test.org.omg.CosNaming.NamingContextPackage.InvalidNameHelper.write (out, $ex);
         }
   ...
   */
       ...
       {
         try {
           String addr = test.org.omg.CosNaming.NamingContextExtPackage.AddressHelper.read (in);
           String sn = test.org.omg.CosNaming.NamingContextExtPackage.StringNameHelper.read (in);
           String $result = null;
           $result = this.to_url (addr, sn);
           out = $rh.createReply();
           out.write_string ($result);
         } catch (test.org.omg.CosNaming.NamingContextExtPackage.InvalidAddress $ex) {
           out = $rh.createExceptionReply ();
           test.org.omg.CosNaming.NamingContextExtPackage.InvalidAddressHelper.write (out, $ex);
         } catch (test.org.omg.CosNaming.NamingContextPackage.InvalidName $ex) {
           out = $rh.createExceptionReply ();
           test.org.omg.CosNaming.NamingContextPackage.InvalidNameHelper.write (out, $ex);
         }
  ...
  public NamingContextExt _this(test.org.omg.CORBA.ORB orb)
  {
    return NamingContextExtHelper.narrow(
