...
/**
* test.org/omg/CosNaming/IstringHelper.java .
...
{
  private static String  _id = "IDL:omg.test.org/CosNaming/Istring:1.0";
  ...
  synchronized public static test.org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = test.org.omg.CORBA.ORB.init ().create_alias_tc (test.org.omg.CosNaming.IstringHelper.id (), "Istring", __typeCode);
    }
    return __typeCode;
  }
