...
/**
* test.org/omg/CosNaming/NamingContextExtPackage/URLStringHelper.java .
...
{
  private static String  _id = "IDL:omg.test.org/CosNaming/NamingContextExt/URLString:1.0";
  ...
  synchronized public static test.org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = test.org.omg.CORBA.ORB.init ().create_alias_tc (test.org.omg.CosNaming.NamingContextExtPackage.URLStringHelper.id (), "URLString", __typeCode);
    }
    return __typeCode;
  }
