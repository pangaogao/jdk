...
/**
* test.org/omg/CosNaming/NameHolder.java .
...
/**
   ...
   */
public final class NameHolder implements test.org.omg.CORBA.portable.Streamable
{
  ...
  public NameHolder (test.org.omg.CosNaming.NameComponent[] initialValue)
  {
    value = initialValue;
  }
  ...
  {
    value = test.org.omg.CosNaming.NameHelper.read (i);
  }

  public void _write (test.org.omg.CORBA.portable.OutputStream o)
  {
    test.org.omg.CosNaming.NameHelper.write (o, value);
  }

  public test.org.omg.CORBA.TypeCode _type ()
  {
    return test.org.omg.CosNaming.NameHelper.type ();
  }
