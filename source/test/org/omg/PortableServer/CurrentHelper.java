...
/**
* test.org/omg/PortableServer/CurrentHelper.java .
...
{
    private static String  _id = "IDL:omg.test.org/PortableServer/Current:2.3";

    public static void insert (test.org.omg.CORBA.Any a,
                               test.org.omg.PortableServer.Current that)
    {
    ...
    public static test.org.omg.PortableServer.Current extract (test.org.omg.CORBA.Any a)
    {
    ...
    synchronized public static test.org.omg.CORBA.TypeCode type ()
    {
        if (__typeCode == null)
        {
            __typeCode = test.org.omg.CORBA.ORB.init ().create_interface_tc (
                test.org.omg.PortableServer.CurrentHelper.id (), "Current");
        }
        return __typeCode;
    }
    ...
    public static test.org.omg.PortableServer.Current read (
    ...
    public static void write (test.org.omg.CORBA.portable.OutputStream ostream,
                              test.org.omg.PortableServer.Current value)
    {
        throw new test.org.omg.CORBA.MARSHAL ();
    }

    public static test.org.omg.PortableServer.Current narrow (
        test.org.omg.CORBA.Object obj)
    {
        if (obj == null)
            return null;
        else if (obj instanceof test.org.omg.PortableServer.Current)
            return (test.org.omg.PortableServer.Current)obj;
