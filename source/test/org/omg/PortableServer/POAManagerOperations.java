...
/**
* test.org/omg/PortableServer/POAManagerOperations.java .
...
public interface POAManagerOperations 
{
  ...
  /**
  	 ...
  	 */
  void activate () throws test.org.omg.PortableServer.POAManagerPackage.AdapterInactive;
  ...
  /**
  	 ...
  	 *            invoked on the POAManager in inactive state.
  	 */
  void hold_requests (boolean wait_for_completion) throws test.org.omg.PortableServer.POAManagerPackage.AdapterInactive;
  ...
  /**
  	 ...
  	 *            invoked on the POAManager in inactive state.
  	 */
  void discard_requests (boolean wait_for_completion) throws test.org.omg.PortableServer.POAManagerPackage.AdapterInactive;
  ...
  /**
  	 ...
  	 *            invoked on the POAManager in inactive state.
  	 */
  void deactivate (boolean etherealize_objects, boolean wait_for_completion) throws test.org.omg.PortableServer.POAManagerPackage.AdapterInactive;

  /**
  	 * This operation returns the state of the POA manager.
  	 */
  test.org.omg.PortableServer.POAManagerPackage.State get_state ();
