...
/**
* test.org/omg/PortableServer/RequestProcessingPolicyValue.java .
...
/**
	 ...
	 */
public class RequestProcessingPolicyValue implements test.org.omg.CORBA.portable.IDLEntity
{
  private        int __value;
  private static int __size = 3;
  private static test.org.omg.PortableServer.RequestProcessingPolicyValue[] __array = new test.org.omg.PortableServer.RequestProcessingPolicyValue [__size];

  public static final int _USE_ACTIVE_OBJECT_MAP_ONLY = 0;
  public static final test.org.omg.PortableServer.RequestProcessingPolicyValue USE_ACTIVE_OBJECT_MAP_ONLY = new test.org.omg.PortableServer.RequestProcessingPolicyValue(_USE_ACTIVE_OBJECT_MAP_ONLY);
  public static final int _USE_DEFAULT_SERVANT = 1;
  public static final test.org.omg.PortableServer.RequestProcessingPolicyValue USE_DEFAULT_SERVANT = new test.org.omg.PortableServer.RequestProcessingPolicyValue(_USE_DEFAULT_SERVANT);
  public static final int _USE_SERVANT_MANAGER = 2;
  public static final test.org.omg.PortableServer.RequestProcessingPolicyValue USE_SERVANT_MANAGER = new test.org.omg.PortableServer.RequestProcessingPolicyValue(_USE_SERVANT_MANAGER);
  ...
  public static test.org.omg.PortableServer.RequestProcessingPolicyValue from_int (int value)
  {
