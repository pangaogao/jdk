...
/**
* test.org/omg/PortableServer/_ServantActivatorStub.java .
...
/**
	 ...
	 */
public class _ServantActivatorStub extends test.org.omg.CORBA.portable.ObjectImpl implements test.org.omg.PortableServer.ServantActivator
{
  ...
  /**
  	 ...
  	 */
  public test.org.omg.PortableServer.Servant incarnate (byte[] oid, test.org.omg.PortableServer.POA adapter) throws test.org.omg.PortableServer.ForwardRequest
  {
      test.org.omg.CORBA.portable.ServantObject $so = _servant_preinvoke ("incarnate", _opsClass);
  ...
  /**
  	 ...
  	 *        completed.
  	 */
  public void etherealize (byte[] oid, test.org.omg.PortableServer.POA adapter, test.org.omg.PortableServer.Servant serv, boolean cleanup_in_progress, boolean remaining_activations)
  {
      test.org.omg.CORBA.portable.ServantObject $so = _servant_preinvoke ("etherealize", _opsClass);
      ServantActivatorOperations  $self = (ServantActivatorOperations) $so.servant;
