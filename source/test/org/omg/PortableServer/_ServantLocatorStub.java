...
/**
* test.org/omg/PortableServer/_ServantLocatorStub.java .
...
/**
	 ...
	 */
public class _ServantLocatorStub extends test.org.omg.CORBA.portable.ObjectImpl implements test.org.omg.PortableServer.ServantLocator
{
  ...
  /**
  	 ...
  	 */
  public test.org.omg.PortableServer.Servant preinvoke (byte[] oid, test.org.omg.PortableServer.POA adapter, String operation, test.org.omg.PortableServer.ServantLocatorPackage.CookieHolder the_cookie) throws test.org.omg.PortableServer.ForwardRequest
  {
      test.org.omg.CORBA.portable.ServantObject $so = _servant_preinvoke ("preinvoke", _opsClass);
  ...
  /**
  	 ...
  	 */
  public void postinvoke (byte[] oid, test.org.omg.PortableServer.POA adapter, String operation, java.lang.Object the_cookie, test.org.omg.PortableServer.Servant the_servant)
  {
      test.org.omg.CORBA.portable.ServantObject $so = _servant_preinvoke ("postinvoke", _opsClass);
      ServantLocatorOperations  $self = (ServantLocatorOperations) $so.servant;
  ...
  private static String[] __ids = {
    "IDL:omg.test.org/PortableServer/ServantLocator:1.0",
