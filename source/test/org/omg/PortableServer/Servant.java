...
import test.org.omg.PortableServer.portable.Delegate;

/**
 * Defines the native <code>Servant</code> type. In Java, the
 * <code>Servant</code> type is mapped to the Java
 * <code>test.org.omg.PortableServer.Servant</code> class.
...
abstract public class Servant {
     ...
     */
    final public test.org.omg.CORBA.Object _this_object() {
     ...
     */
    final public test.org.omg.CORBA.Object _this_object(ORB orb) {
        try {
            ...
            throw
                ...
                ("POA Servant requires an instance of test.org.omg.CORBA_2_3.ORB");
        }
        return _this_object();
    }
    ...
    */
    ...
    public test.org.omg.CORBA.Object _get_interface_def()
    {
        ...
        test.org.omg.PortableServer.portable.Delegate delegate = _get_delegate();
        try {
            ...
            try {
                Class[] argc = { test.org.omg.PortableServer.Servant.class };
