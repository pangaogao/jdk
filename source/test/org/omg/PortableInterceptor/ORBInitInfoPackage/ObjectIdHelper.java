...
/**
* test.org/omg/PortableInterceptor/ORBInitInfoPackage/ObjectIdHelper.java .
...
{
  private static String  _id = "IDL:omg.test.org/PortableInterceptor/ORBInitInfo/ObjectId:1.0";
  ...
  synchronized public static test.org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = test.org.omg.CORBA.ORB.init ().create_alias_tc (test.org.omg.PortableInterceptor.ORBInitInfoPackage.ObjectIdHelper.id (), "ObjectId", __typeCode);
    }
    return __typeCode;
  }
