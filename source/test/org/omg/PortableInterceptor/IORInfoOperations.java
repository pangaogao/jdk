...
/**
* test.org/omg/PortableInterceptor/IORInfoOperations.java .
...
public interface IORInfoOperations 
{
  ...
  /**
       ...
       */
  test.org.omg.CORBA.Policy get_effective_policy (int type);
  ...
  /**
       ...
       */
  void add_ior_component (test.org.omg.IOP.TaggedComponent tagged_component);
  ...
  /**
       ...
       */
  void add_ior_component_to_profile (test.org.omg.IOP.TaggedComponent tagged_component, int profile_id);
  ...
  /** Return the object reference template of the object adapter
       * that was just created and is running IOR interceptors.
       */
  test.org.omg.PortableInterceptor.ObjectReferenceTemplate adapter_template ();
  ...
  /** On read, returns the current factory that will be used to create
       ...
       * IORInterceptor_3_0.
       */
  test.org.omg.PortableInterceptor.ObjectReferenceFactory current_factory ();
  ...
  /** On read, returns the current factory that will be used to create
       ...
       * IORInterceptor_3_0.
       */
  void current_factory (test.org.omg.PortableInterceptor.ObjectReferenceFactory newCurrent_factory);
