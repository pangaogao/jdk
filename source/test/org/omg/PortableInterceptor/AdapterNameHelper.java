...
/**
* test.org/omg/PortableInterceptor/AdapterNameHelper.java .
...
{
  private static String  _id = "IDL:omg.test.org/PortableInterceptor/AdapterName:1.0";
  ...
  synchronized public static test.org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = test.org.omg.CORBA.ORB.init ().create_alias_tc (test.org.omg.CORBA.StringSeqHelper.id (), "StringSeq", __typeCode);
      __typeCode = test.org.omg.CORBA.ORB.init ().create_alias_tc (test.org.omg.PortableInterceptor.AdapterNameHelper.id (), "AdapterName", __typeCode);
    }
    return __typeCode;
  }
  ...
  {
    String value[] = null;
    value = test.org.omg.CORBA.StringSeqHelper.read (istream);
    return value;
  }

  public static void write (test.org.omg.CORBA.portable.OutputStream ostream, String[] value)
  {
    test.org.omg.CORBA.StringSeqHelper.write (ostream, value);
  }
