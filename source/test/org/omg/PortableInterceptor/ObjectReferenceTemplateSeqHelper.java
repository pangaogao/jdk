...
/**
* test.org/omg/PortableInterceptor/ObjectReferenceTemplateSeqHelper.java .
...
{
  private static String  _id = "IDL:omg.test.org/PortableInterceptor/ObjectReferenceTemplateSeq:1.0";
  ...
  synchronized public static test.org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      __typeCode = test.org.omg.PortableInterceptor.ObjectReferenceTemplateHelper.type ();
      __typeCode = test.org.omg.CORBA.ORB.init ().create_sequence_tc (0, __typeCode);
      __typeCode = test.org.omg.CORBA.ORB.init ().create_alias_tc (test.org.omg.PortableInterceptor.ObjectReferenceTemplateSeqHelper.id (), "ObjectReferenceTemplateSeq", __typeCode);
    }
    return __typeCode;
  }
  ...
  {
    test.org.omg.PortableInterceptor.ObjectReferenceTemplate value[] = null;
    int _len0 = istream.read_long ();
    value = new test.org.omg.PortableInterceptor.ObjectReferenceTemplate[_len0];
    for (int _o1 = 0;_o1 < value.length; ++_o1)
      value[_o1] = test.org.omg.PortableInterceptor.ObjectReferenceTemplateHelper.read (istream);
    return value;
  }
  ...
  public static void write (test.org.omg.CORBA.portable.OutputStream ostream, test.org.omg.PortableInterceptor.ObjectReferenceTemplate[] value)
  {
    ...
    for (int _i0 = 0;_i0 < value.length; ++_i0)
      test.org.omg.PortableInterceptor.ObjectReferenceTemplateHelper.write (ostream, value[_i0]);
  }
