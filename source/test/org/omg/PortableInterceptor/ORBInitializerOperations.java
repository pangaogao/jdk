...
/**
* test.org/omg/PortableInterceptor/ORBInitializerOperations.java .
...
/**
   ...
   *   <blockquote><code>
   *     test.org.omg.PortableInterceptor.ORBInitializerClass.&lt;Service&gt;
   *   </code></blockquote>
   * where <code>&lt;Service&gt;</code> is the string name of a class 
   * which implements 
   *   <blockquote><code>
   *     test.org.omg.PortableInterceptor.ORBInitializer
   *   </code></blockquote>
   ...
   * <ul>
   *   <li><code>
   *     test.org.omg.PortableInterceptor.ORBInitializerClass.com.x.Init1
   *   </code></li>
   *   <li><code>
   *     test.org.omg.PortableInterceptor.ORBInitializerClass.com.x.Init2
   *   </code></li>
   *   <li><code>
   *     test.org.omg.PortableInterceptor.ORBInitializerClass.com.x.Init3
   *   </code></li>
   * </ul>
   * During ORB.init, these ORB properties which begin with 
   * <code>test.org.omg.PortableInterceptor.ORBInitializerClass</code> shall be
...
public interface ORBInitializerOperations 
{
  ...
  /** 
       ...
       */
  void pre_init (test.org.omg.PortableInterceptor.ORBInitInfo info);
  ...
  /**
       ...
       */
  void post_init (test.org.omg.PortableInterceptor.ORBInitInfo info);
