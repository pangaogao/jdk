...
/**
* test.org/omg/PortableInterceptor/RequestInfoOperations.java .
...
public interface RequestInfoOperations 
{
  ...
  /**
       ...
       */
  test.org.omg.Dynamic.Parameter[] arguments ();
  ...
  /**
       ...
       *     limitations / unimplemented features</a>
       */
  test.org.omg.CORBA.TypeCode[] exceptions ();
  ...
  /** 
       ...
       */
  test.org.omg.CORBA.Object forward_reference ();
  ...
  /**
       ...
       * @see Current
       */
  test.org.omg.CORBA.Any get_slot (int id) throws test.org.omg.PortableInterceptor.InvalidSlot;
  ...
  /**
       ...
       */
  test.org.omg.IOP.ServiceContext get_request_service_context (int id);
  ...
  /**
       ...
       *     request's service context does not contain an entry for that ID.
       */
  test.org.omg.IOP.ServiceContext get_reply_service_context (int id);
