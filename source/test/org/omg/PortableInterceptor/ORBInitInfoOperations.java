...
/**
* test.org/omg/PortableInterceptor/ORBInitInfoOperations.java .
...
public interface ORBInitInfoOperations 
{
  ...
  /** 
       ...
       * initialization.
       */
  test.org.omg.IOP.CodecFactory codec_factory ();
  ...
  /** 
       ...
       * identical.
       */
  void register_initial_reference (String id, test.org.omg.CORBA.Object obj) throws test.org.omg.PortableInterceptor.ORBInitInfoPackage.InvalidName;
  ...
  /**
       ...
       */
  test.org.omg.CORBA.Object resolve_initial_references (String id) throws test.org.omg.PortableInterceptor.ORBInitInfoPackage.InvalidName;
  ...
  /**
       ...
       */
  void add_client_request_interceptor (test.org.omg.PortableInterceptor.ClientRequestInterceptor interceptor) throws test.org.omg.PortableInterceptor.ORBInitInfoPackage.DuplicateName;
  ...
  /** 
       ...
       *     has already been registered with this Interceptor's name
       */
  void add_server_request_interceptor (test.org.omg.PortableInterceptor.ServerRequestInterceptor interceptor) throws test.org.omg.PortableInterceptor.ORBInitInfoPackage.DuplicateName;
  ...
  /**
       ...
       */
  void add_ior_interceptor (test.org.omg.PortableInterceptor.IORInterceptor interceptor) throws test.org.omg.PortableInterceptor.ORBInitInfoPackage.DuplicateName;
  ...
  /**
       ...
       *     <code>PolicyType</code>.
       */
  void register_policy_factory (int type, test.org.omg.PortableInterceptor.PolicyFactory policy_factory);
