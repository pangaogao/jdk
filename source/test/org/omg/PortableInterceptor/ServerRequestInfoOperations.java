...
/**
* test.org/omg/PortableInterceptor/ServerRequestInfoOperations.java .
...
/**
   ...
   */
public interface ServerRequestInfoOperations  extends test.org.omg.PortableInterceptor.RequestInfoOperations
{
  ...
  /**
       ...
       */
  test.org.omg.CORBA.Any sending_exception ();
  ...
  /**
       ...
       */
  test.org.omg.CORBA.Policy get_server_policy (int type);
  ...
  /**
       ...
       * @see Current
       */
  void set_slot (int id, test.org.omg.CORBA.Any data) throws test.org.omg.PortableInterceptor.InvalidSlot;
  ...
  /**
       ...
       *     given ID.
       */
  void add_reply_service_context (test.org.omg.IOP.ServiceContext service_context, boolean replace);
