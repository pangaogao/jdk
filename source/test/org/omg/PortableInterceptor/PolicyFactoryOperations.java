...
/**
* test.org/omg/PortableInterceptor/PolicyFactoryOperations.java .
...
public interface PolicyFactoryOperations 
{
  ...
  /**
       ...
       *     value.
       */
  test.org.omg.CORBA.Policy create_policy (int type, test.org.omg.CORBA.Any value) throws test.org.omg.CORBA.PolicyError;
