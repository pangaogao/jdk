...
/**
* test.org/omg/PortableInterceptor/IORInterceptor_3_0Operations.java .
...
public interface IORInterceptor_3_0Operations  extends test.org.omg.PortableInterceptor.IORInterceptorOperations
{
  ...
  /** The components_established method is invoked on all registered 
       ...
       */
  void components_established (test.org.omg.PortableInterceptor.IORInfo info);
  ...
  /** Called whenever the state of an object adapter changes, and
       ...
       */
  void adapter_state_changed (test.org.omg.PortableInterceptor.ObjectReferenceTemplate[] templates, short state);
