...
/**
* test.org/omg/IOP/ServiceContextHolder.java .
...
public final class ServiceContextHolder implements test.org.omg.CORBA.portable.Streamable
{
  ...
  public ServiceContextHolder (test.org.omg.IOP.ServiceContext initialValue)
  {
    value = initialValue;
  }
  ...
  {
    value = test.org.omg.IOP.ServiceContextHelper.read (i);
  }

  public void _write (test.org.omg.CORBA.portable.OutputStream o)
  {
    test.org.omg.IOP.ServiceContextHelper.write (o, value);
  }

  public test.org.omg.CORBA.TypeCode _type ()
  {
    return test.org.omg.IOP.ServiceContextHelper.type ();
  }
