...
/**
* test.org/omg/IOP/ServiceIdHelper.java .
...
{
  private static String  _id = "IDL:omg.test.org/IOP/ServiceId:1.0";
  ...
  synchronized public static test.org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = test.org.omg.CORBA.ORB.init ().create_alias_tc (test.org.omg.IOP.ServiceIdHelper.id (), "ServiceId", __typeCode);
    }
    return __typeCode;
  }
