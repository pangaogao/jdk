...
/**
* test.org/omg/IOP/ComponentIdHelper.java .
...
{
  private static String  _id = "IDL:omg.test.org/IOP/ComponentId:1.0";
  ...
  synchronized public static test.org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = test.org.omg.CORBA.ORB.init ().create_alias_tc (test.org.omg.IOP.ComponentIdHelper.id (), "ComponentId", __typeCode);
    }
    return __typeCode;
  }
