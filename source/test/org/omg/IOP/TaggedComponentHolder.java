...
/**
* test.org/omg/IOP/TaggedComponentHolder.java .
...
public final class TaggedComponentHolder implements test.org.omg.CORBA.portable.Streamable
{
  ...
  public TaggedComponentHolder (test.org.omg.IOP.TaggedComponent initialValue)
  {
    value = initialValue;
  }
  ...
  {
    value = test.org.omg.IOP.TaggedComponentHelper.read (i);
  }

  public void _write (test.org.omg.CORBA.portable.OutputStream o)
  {
    test.org.omg.IOP.TaggedComponentHelper.write (o, value);
  }

  public test.org.omg.CORBA.TypeCode _type ()
  {
    return test.org.omg.IOP.TaggedComponentHelper.type ();
  }
