...
/**
* test.org/omg/IOP/CodecOperations.java .
...
public interface CodecOperations 
{
  ...
  /**
       ...
       */
  byte[] encode (test.org.omg.CORBA.Any data) throws test.org.omg.IOP.CodecPackage.InvalidTypeForEncoding;
  ...
  /**
       ...
       *     decoded into an Any. 
       */
  test.org.omg.CORBA.Any decode (byte[] data) throws test.org.omg.IOP.CodecPackage.FormatMismatch;
  ...
  /**
       ...
       *     the encoding format effective for this <code>Codec</code>.
       */
  byte[] encode_value (test.org.omg.CORBA.Any data) throws test.org.omg.IOP.CodecPackage.InvalidTypeForEncoding;
  ...
  /**
       ...
       *     decoded into an Any. 
       */
  test.org.omg.CORBA.Any decode_value (byte[] data, test.org.omg.CORBA.TypeCode tc) throws test.org.omg.IOP.CodecPackage.FormatMismatch, test.org.omg.IOP.CodecPackage.TypeMismatch;
