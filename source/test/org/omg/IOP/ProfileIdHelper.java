...
/**
* test.org/omg/IOP/ProfileIdHelper.java .
...
{
  private static String  _id = "IDL:omg.test.org/IOP/ProfileId:1.0";
  ...
  synchronized public static test.org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = test.org.omg.CORBA.ORB.init ().create_alias_tc (test.org.omg.IOP.ProfileIdHelper.id (), "ProfileId", __typeCode);
    }
    return __typeCode;
  }
