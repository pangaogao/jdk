...
/**
* test.org/omg/DynamicAny/_DynAnyFactoryStub.java .
...
/**
    ...
    */
public class _DynAnyFactoryStub extends test.org.omg.CORBA.portable.ObjectImpl implements test.org.omg.DynamicAny.DynAnyFactory
{
  ...
  /**
          ...
          */
  public test.org.omg.DynamicAny.DynAny create_dyn_any (test.org.omg.CORBA.Any value) throws test.org.omg.DynamicAny.DynAnyFactoryPackage.InconsistentTypeCode
  {
      test.org.omg.CORBA.portable.ServantObject $so = _servant_preinvoke ("create_dyn_any", _opsClass);
  ...
  /**
          ...
          * </UL>
          */
  public test.org.omg.DynamicAny.DynAny create_dyn_any_from_type_code (test.org.omg.CORBA.TypeCode type) throws test.org.omg.DynamicAny.DynAnyFactoryPackage.InconsistentTypeCode
  {
      test.org.omg.CORBA.portable.ServantObject $so = _servant_preinvoke ("create_dyn_any_from_type_code", _opsClass);
      DynAnyFactoryOperations  $self = (DynAnyFactoryOperations) $so.servant;
  ...
  private static String[] __ids = {
    "IDL:omg.test.org/DynamicAny/DynAnyFactory:1.0"};
