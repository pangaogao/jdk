...
/**
* test.org/omg/DynamicAny/DynAnyHelper.java .
...
{
  private static String  _id = "IDL:omg.test.org/DynamicAny/DynAny:1.0";

  public static void insert (test.org.omg.CORBA.Any a, test.org.omg.DynamicAny.DynAny that)
  {
  ...
  public static test.org.omg.DynamicAny.DynAny extract (test.org.omg.CORBA.Any a)
  {
  ...
  synchronized public static test.org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      __typeCode = test.org.omg.CORBA.ORB.init ().create_interface_tc (test.org.omg.DynamicAny.DynAnyHelper.id (), "DynAny");
    }
    return __typeCode;
  }
  ...
  public static test.org.omg.DynamicAny.DynAny read (test.org.omg.CORBA.portable.InputStream istream)
  {
      throw new test.org.omg.CORBA.MARSHAL ();
  }

  public static void write (test.org.omg.CORBA.portable.OutputStream ostream, test.org.omg.DynamicAny.DynAny value)
  {
      throw new test.org.omg.CORBA.MARSHAL ();
  }

  public static test.org.omg.DynamicAny.DynAny narrow (test.org.omg.CORBA.Object obj)
  {
    if (obj == null)
      return null;
    else if (obj instanceof test.org.omg.DynamicAny.DynAny)
      return (test.org.omg.DynamicAny.DynAny)obj;
    ...
    else
    {
      ...
      test.org.omg.DynamicAny._DynAnyStub stub = new test.org.omg.DynamicAny._DynAnyStub ();
      stub._set_delegate(delegate);
      return stub;
    }
  }

  public static test.org.omg.DynamicAny.DynAny unchecked_narrow (test.org.omg.CORBA.Object obj)
  {
    if (obj == null)
      return null;
    else if (obj instanceof test.org.omg.DynamicAny.DynAny)
