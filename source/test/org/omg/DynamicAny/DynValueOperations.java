...
/**
* test.org/omg/DynamicAny/DynValueOperations.java .
...
/**
    ...
    */
public interface DynValueOperations  extends test.org.omg.DynamicAny.DynValueCommonOperations
{
  ...
  /**
          ...
          */
  String current_member_name () throws test.org.omg.DynamicAny.DynAnyPackage.TypeMismatch, test.org.omg.DynamicAny.DynAnyPackage.InvalidValue;
  ...
  /**
          ...
          * @exception InvalidValue if the current position does not indicate a member
          */
  test.org.omg.CORBA.TCKind current_member_kind () throws test.org.omg.DynamicAny.DynAnyPackage.TypeMismatch, test.org.omg.DynamicAny.DynAnyPackage.InvalidValue;
  ...
  /**
          ...
          */
  test.org.omg.DynamicAny.NameValuePair[] get_members () throws test.org.omg.DynamicAny.DynAnyPackage.InvalidValue;
  ...
  /**
          ...
          */
  void set_members (test.org.omg.DynamicAny.NameValuePair[] value) throws test.org.omg.DynamicAny.DynAnyPackage.TypeMismatch, test.org.omg.DynamicAny.DynAnyPackage.InvalidValue;
  ...
  /**
          ...
          * @exception InvalidValue if this object represents a null value type
          */
  test.org.omg.DynamicAny.NameDynAnyPair[] get_members_as_dyn_any () throws test.org.omg.DynamicAny.DynAnyPackage.InvalidValue;
  ...
  /**
          ...
          *            with the number of members as indicated by the DynValue's TypeCode
          */
  void set_members_as_dyn_any (test.org.omg.DynamicAny.NameDynAnyPair[] value) throws test.org.omg.DynamicAny.DynAnyPackage.TypeMismatch, test.org.omg.DynamicAny.DynAnyPackage.InvalidValue;
