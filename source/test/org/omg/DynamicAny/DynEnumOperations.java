...
/**
* test.org/omg/DynamicAny/DynEnumOperations.java .
...
/**
    ...
    */
public interface DynEnumOperations  extends test.org.omg.DynamicAny.DynAnyOperations
{
  ...
  /**
          ...
          */
  void set_as_string (String value) throws test.org.omg.DynamicAny.DynAnyPackage.InvalidValue;
  ...
  /**
          ...
          *            for the corresponding enumerated type
          */
  void set_as_ulong (int value) throws test.org.omg.DynamicAny.DynAnyPackage.InvalidValue;
