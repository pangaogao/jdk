...
/**
* test.org/omg/DynamicAny/DynSequenceOperations.java .
...
/**
    ...
    */
public interface DynSequenceOperations  extends test.org.omg.DynamicAny.DynAnyOperations
{
  ...
  /**
          ...
          */
  void set_length (int len) throws test.org.omg.DynamicAny.DynAnyPackage.InvalidValue;

  /**
          * Returns the elements of the sequence.
          */
  test.org.omg.CORBA.Any[] get_elements ();
  ...
  /**
          ...
          */
  void set_elements (test.org.omg.CORBA.Any[] value) throws test.org.omg.DynamicAny.DynAnyPackage.TypeMismatch, test.org.omg.DynamicAny.DynAnyPackage.InvalidValue;

  /**
          * Returns the DynAnys representing the elements of the sequence.
          */
  test.org.omg.DynamicAny.DynAny[] get_elements_as_dyn_any ();
  ...
  /**
          ...
          * @exception InvalidValue if the length of value exceeds the bound of a bounded sequence
          */
  void set_elements_as_dyn_any (test.org.omg.DynamicAny.DynAny[] value) throws test.org.omg.DynamicAny.DynAnyPackage.TypeMismatch, test.org.omg.DynamicAny.DynAnyPackage.InvalidValue;
