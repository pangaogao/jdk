 ...
 * of CORBA object.  It extends test.org.omg.CORBA.portable.Delegate and
 * provides new methods that were defined by CORBA 2.3.
 *
 * @see test.org.omg.CORBA.portable.Delegate
 * @author  OMG
 * @since   JDK1.2
 */

public abstract class Delegate extends test.org.omg.CORBA.portable.Delegate {
     ...
     * null if none.
     */
    public java.lang.String get_codebase(test.org.omg.CORBA.Object self) {
        return null;
    }
}
