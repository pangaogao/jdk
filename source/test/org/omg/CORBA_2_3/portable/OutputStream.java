...
package test.org.omg.CORBA_2_3.portable;
 ...
 * to the stream. It extends test.org.omg.CORBA.portable.OutputStream, and defines
 * new methods defined by CORBA 2.3.
 *
 * @see test.org.omg.CORBA.portable.OutputStream
 * @author  OMG
 * @since   JDK1.2
 */

public abstract class OutputStream extends test.org.omg.CORBA.portable.OutputStream {
     ...
     * the boxed value
     */
    public void write_value(java.io.Serializable value, test.org.omg.CORBA.portable.BoxedValueHelper factory) {
        throw new test.org.omg.CORBA.NO_IMPLEMENT();
    }
