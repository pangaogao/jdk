 ...
 * from the stream. It extends test.org.omg.CORBA.portable.InputStream.  This
 * class defines new methods that were added for CORBA 2.3.
 *
 * @see test.org.omg.CORBA.portable.InputStream
 * @author  OMG
 * @since   JDK1.2
 */

public abstract class InputStream extends test.org.omg.CORBA.portable.InputStream {
     ...
     * @return the value unmarshalled from the input stream
     */
    public java.io.Serializable read_value(test.org.omg.CORBA.portable.BoxedValueHelper factory) {
        throw new test.org.omg.CORBA.NO_IMPLEMENT();
    }
