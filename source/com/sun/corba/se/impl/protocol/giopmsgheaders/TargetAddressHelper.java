...
abstract public class TargetAddressHelper
{
  ...
  public static void insert (test.org.omg.CORBA.Any a, com.sun.corba.se.impl.protocol.giopmsgheaders.TargetAddress that)
  {
  ...
  public static com.sun.corba.se.impl.protocol.giopmsgheaders.TargetAddress extract (test.org.omg.CORBA.Any a)
  {
  ...
  synchronized public static test.org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      test.org.omg.CORBA.TypeCode _disTypeCode0;
      _disTypeCode0 = test.org.omg.CORBA.ORB.init ().get_primitive_tc (test.org.omg.CORBA.TCKind.tk_short);
      _disTypeCode0 = test.org.omg.CORBA.ORB.init ().create_alias_tc (com.sun.corba.se.impl.protocol.giopmsgheaders.AddressingDispositionHelper.id (), "AddressingDisposition", _disTypeCode0);
      test.org.omg.CORBA.UnionMember[] _members0 = new test.org.omg.CORBA.UnionMember [3];
      test.org.omg.CORBA.TypeCode _tcOf_members0;
      test.org.omg.CORBA.Any _anyOf_members0;

      // Branch for object_key
      _anyOf_members0 = test.org.omg.CORBA.ORB.init ().create_any ();
      _anyOf_members0.insert_short ((short)com.sun.corba.se.impl.protocol.giopmsgheaders.KeyAddr.value);
      _tcOf_members0 = test.org.omg.CORBA.ORB.init ().get_primitive_tc (test.org.omg.CORBA.TCKind.tk_octet);
      _tcOf_members0 = test.org.omg.CORBA.ORB.init ().create_sequence_tc (0, _tcOf_members0);
      _members0[0] = new test.org.omg.CORBA.UnionMember (
        "object_key",
        _anyOf_members0,
        _tcOf_members0,
        null);
      ...
      _members0[1] = new test.org.omg.CORBA.UnionMember (
        "profile",
        _anyOf_members0,
        _tcOf_members0,
        null);
      ...
      _members0[2] = new test.org.omg.CORBA.UnionMember (
        "ior",
        _anyOf_members0,
        _tcOf_members0,
        null);
      __typeCode = test.org.omg.CORBA.ORB.init ().create_union_tc (com.sun.corba.se.impl.protocol.giopmsgheaders.TargetAddressHelper.id (), "TargetAddress", _disTypeCode0, _members0);
    }
    return __typeCode;
  }
  ...
  public static com.sun.corba.se.impl.protocol.giopmsgheaders.TargetAddress read (test.org.omg.CORBA.portable.InputStream istream)
  {
    ...
    switch (_dis0)
    {
      ...
      case com.sun.corba.se.impl.protocol.giopmsgheaders.ProfileAddr.value:
        test.org.omg.IOP.TaggedProfile _profile = null;
        _profile = test.org.omg.IOP.TaggedProfileHelper.read (istream);
  ...
  public static void write (test.org.omg.CORBA.portable.OutputStream ostream, com.sun.corba.se.impl.protocol.giopmsgheaders.TargetAddress value)
  {
    ...
    switch (value.discriminator ())
    {
      case com.sun.corba.se.impl.protocol.giopmsgheaders.KeyAddr.value:
        ...
        break;
      case com.sun.corba.se.impl.protocol.giopmsgheaders.ProfileAddr.value:
        test.org.omg.IOP.TaggedProfileHelper.write (ostream, value.profile ());
        break;
      case com.sun.corba.se.impl.protocol.giopmsgheaders.ReferenceAddr.value:
