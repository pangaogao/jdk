...
abstract public class ServerDefHelper
{
  ...
  public static void insert (test.org.omg.CORBA.Any a, com.sun.corba.se.spi.activation.RepositoryPackage.ServerDef that)
  {
  ...
  public static com.sun.corba.se.spi.activation.RepositoryPackage.ServerDef extract (test.org.omg.CORBA.Any a)
  {
    ...
    if (__typeCode == null)
    {
      synchronized (test.org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          __active = true;
          test.org.omg.CORBA.StructMember[] _members0 = new test.org.omg.CORBA.StructMember [5];
          ...
          _members0[4] = new test.org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = test.org.omg.CORBA.ORB.init ().create_struct_tc (com.sun.corba.se.spi.activation.RepositoryPackage.ServerDefHelper.id (), "ServerDef", _members0);
          __active = false;
        }
      }
    }
  ...
  public static com.sun.corba.se.spi.activation.RepositoryPackage.ServerDef read (test.org.omg.CORBA.portable.InputStream istream)
  {
  ...
  public static void write (test.org.omg.CORBA.portable.OutputStream ostream, com.sun.corba.se.spi.activation.RepositoryPackage.ServerDef value)
  {
