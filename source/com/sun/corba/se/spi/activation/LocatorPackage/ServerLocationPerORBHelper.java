...
abstract public class ServerLocationPerORBHelper
{
  ...
  public static void insert (test.org.omg.CORBA.Any a, com.sun.corba.se.spi.activation.LocatorPackage.ServerLocationPerORB that)
  {
  ...
  public static com.sun.corba.se.spi.activation.LocatorPackage.ServerLocationPerORB extract (test.org.omg.CORBA.Any a)
  {
    ...
    if (__typeCode == null)
    {
      synchronized (test.org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _tcOf_members0 = test.org.omg.CORBA.ORB.init ().create_alias_tc (com.sun.corba.se.spi.activation.EndpointInfoListHelper.id (), "EndpointInfoList", _tcOf_members0);
          _members0[1] = new test.org.omg.CORBA.StructMember (
            "ports",
            _tcOf_members0,
            null);
          __typeCode = test.org.omg.CORBA.ORB.init ().create_struct_tc (com.sun.corba.se.spi.activation.LocatorPackage.ServerLocationPerORBHelper.id (), "ServerLocationPerORB", _members0);
          __active = false;
        }
      }
    }
  ...
  public static com.sun.corba.se.spi.activation.LocatorPackage.ServerLocationPerORB read (test.org.omg.CORBA.portable.InputStream istream)
  {
  ...
  public static void write (test.org.omg.CORBA.portable.OutputStream ostream, com.sun.corba.se.spi.activation.LocatorPackage.ServerLocationPerORB value)
  {
