...
abstract public class InvalidORBidHelper
{
  ...
  public static void insert (test.org.omg.CORBA.Any a, com.sun.corba.se.spi.activation.InvalidORBid that)
  {
  ...
  public static com.sun.corba.se.spi.activation.InvalidORBid extract (test.org.omg.CORBA.Any a)
  {
    ...
    if (__typeCode == null)
    {
      synchronized (test.org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          __typeCode = test.org.omg.CORBA.ORB.init ().create_exception_tc (com.sun.corba.se.spi.activation.InvalidORBidHelper.id (), "InvalidORBid", _members0);
          __active = false;
        }
      }
    }
  ...
  public static com.sun.corba.se.spi.activation.InvalidORBid read (test.org.omg.CORBA.portable.InputStream istream)
  {
  ...
  public static void write (test.org.omg.CORBA.portable.OutputStream ostream, com.sun.corba.se.spi.activation.InvalidORBid value)
  {
