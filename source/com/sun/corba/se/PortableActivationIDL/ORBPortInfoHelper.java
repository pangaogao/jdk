...
abstract public class ORBPortInfoHelper
{
  ...
  public static void insert (test.org.omg.CORBA.Any a, com.sun.corba.se.PortableActivationIDL.ORBPortInfo that)
  {
  ...
  public static com.sun.corba.se.PortableActivationIDL.ORBPortInfo extract (test.org.omg.CORBA.Any a)
  {
    ...
    if (__typeCode == null)
    {
      synchronized (test.org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _tcOf_members0 = test.org.omg.CORBA.ORB.init ().create_alias_tc (test.org.omg.PortableInterceptor.ORBIdHelper.id (), "ORBId", _tcOf_members0);
          _members0[0] = new test.org.omg.CORBA.StructMember (
            "orbId",
            _tcOf_members0,
            null);
          _tcOf_members0 = test.org.omg.CORBA.ORB.init ().get_primitive_tc (test.org.omg.CORBA.TCKind.tk_long);
          _tcOf_members0 = test.org.omg.CORBA.ORB.init ().create_alias_tc (com.sun.corba.se.PortableActivationIDL.TCPPortHelper.id (), "TCPPort", _tcOf_members0);
          _members0[1] = new test.org.omg.CORBA.StructMember (
            "port",
            _tcOf_members0,
            null);
          __typeCode = test.org.omg.CORBA.ORB.init ().create_struct_tc (com.sun.corba.se.PortableActivationIDL.ORBPortInfoHelper.id (), "ORBPortInfo", _members0);
          __active = false;
        }
      }
    }
  ...
  public static com.sun.corba.se.PortableActivationIDL.ORBPortInfo read (test.org.omg.CORBA.portable.InputStream istream)
  {
  ...
  public static void write (test.org.omg.CORBA.portable.OutputStream ostream, com.sun.corba.se.PortableActivationIDL.ORBPortInfo value)
  {
