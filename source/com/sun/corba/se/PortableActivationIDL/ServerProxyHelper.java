...
abstract public class ServerProxyHelper
{
  ...
  public static void insert (test.org.omg.CORBA.Any a, com.sun.corba.se.PortableActivationIDL.ServerProxy that)
  {
  ...
  public static com.sun.corba.se.PortableActivationIDL.ServerProxy extract (test.org.omg.CORBA.Any a)
  {
  ...
  synchronized public static test.org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      __typeCode = test.org.omg.CORBA.ORB.init ().create_interface_tc (com.sun.corba.se.PortableActivationIDL.ServerProxyHelper.id (), "ServerProxy");
    }
    return __typeCode;
  }
  ...
  public static com.sun.corba.se.PortableActivationIDL.ServerProxy read (test.org.omg.CORBA.portable.InputStream istream)
  {
    return narrow (istream.read_Object (_ServerProxyStub.class));
  }

  public static void write (test.org.omg.CORBA.portable.OutputStream ostream, com.sun.corba.se.PortableActivationIDL.ServerProxy value)
  {
    ostream.write_Object ((test.org.omg.CORBA.Object) value);
  }

  public static com.sun.corba.se.PortableActivationIDL.ServerProxy narrow (test.org.omg.CORBA.Object obj)
  {
    if (obj == null)
      return null;
  ...
  public static com.sun.corba.se.PortableActivationIDL.ServerProxy unchecked_narrow (test.org.omg.CORBA.Object obj)
  {
    if (obj == null)
      return null;
    else if (obj instanceof com.sun.corba.se.PortableActivationIDL.ServerProxy)
