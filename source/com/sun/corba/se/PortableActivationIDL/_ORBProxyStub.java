...
/** ORB callback interface, passed to Activator in registerORB method.
    */
public class _ORBProxyStub extends test.org.omg.CORBA.portable.ObjectImpl implements com.sun.corba.se.PortableActivationIDL.ORBProxy
{
  ...
  public boolean activate_adapter (String[] name)
  {
            ...
            try {
                test.org.omg.CORBA.portable.OutputStream $out = _request ("activate_adapter", true);
                test.org.omg.PortableInterceptor.AdapterNameHelper.write ($out, name);
                $in = _invoke ($out);
