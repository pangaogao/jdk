...
abstract public class ServerHeldDownHelper
{
  ...
  public static void insert (test.org.omg.CORBA.Any a, com.sun.corba.se.PortableActivationIDL.ServerHeldDown that)
  {
  ...
  public static com.sun.corba.se.PortableActivationIDL.ServerHeldDown extract (test.org.omg.CORBA.Any a)
  {
      ...
      synchronized (test.org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[0] = new test.org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = test.org.omg.CORBA.ORB.init ().create_exception_tc (com.sun.corba.se.PortableActivationIDL.ServerHeldDownHelper.id (), "ServerHeldDown", _members0);
          __active = false;
        }
      }
    }
  ...
  public static com.sun.corba.se.PortableActivationIDL.ServerHeldDown read (test.org.omg.CORBA.portable.InputStream istream)
  {
  ...
  public static void write (test.org.omg.CORBA.portable.OutputStream ostream, com.sun.corba.se.PortableActivationIDL.ServerHeldDown value)
  {
