...
/** Interface used to combine the Activator and Locator when both are
    ...
    */
public class _ServerManagerStub extends test.org.omg.CORBA.portable.ObjectImpl implements com.sun.corba.se.PortableActivationIDL.ServerManager
{
  ...
  public void serverGoingDown (String serverId)
  {
            test.org.omg.CORBA.portable.InputStream $in = null;
            try {
                test.org.omg.CORBA.portable.OutputStream $out = _request ("serverGoingDown", true);
                test.org.omg.PortableInterceptor.ServerIdHelper.write ($out, serverId);
                $in = _invoke ($out);
                return;
            } catch (test.org.omg.CORBA.portable.ApplicationException $ex) {
  ...
  public void registerORB (String serverId, String orbId, com.sun.corba.se.PortableActivationIDL.ORBProxy orb, com.sun.corba.se.PortableActivationIDL.EndPointInfo[] endPointInfo) throws com.sun.corba.se.PortableActivationIDL.ServerNotRegistered, com.sun.corba.se.PortableActivationIDL.NoSuchEndPoint, com.sun.corba.se.PortableActivationIDL.ORBAlreadyRegistered
  {
            test.org.omg.CORBA.portable.InputStream $in = null;
            try {
                test.org.omg.CORBA.portable.OutputStream $out = _request ("registerORB", true);
                test.org.omg.PortableInterceptor.ServerIdHelper.write ($out, serverId);
  ...
  /** Construct or find an ORBD object template corresponding to the 
  	...
  	*/
  public test.org.omg.PortableInterceptor.ObjectReferenceTemplate registerPOA (String serverId, String orbId, test.org.omg.PortableInterceptor.ObjectReferenceTemplate poaTemplate)
  {
            test.org.omg.CORBA.portable.InputStream $in = null;
            try {
                test.org.omg.CORBA.portable.OutputStream $out = _request ("registerPOA", true);
                test.org.omg.PortableInterceptor.ServerIdHelper.write ($out, serverId);
                test.org.omg.PortableInterceptor.ORBIdHelper.write ($out, orbId);
                test.org.omg.PortableInterceptor.ObjectReferenceTemplateHelper.write ($out, poaTemplate);
                $in = _invoke ($out);
                test.org.omg.PortableInterceptor.ObjectReferenceTemplate $result = test.org.omg.PortableInterceptor.ObjectReferenceTemplateHelper.read ($in);
                return $result;
            } catch (test.org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
  ...
  /** Called whenever a POA is destroyed.
  	*/
  public void poaDestroyed (String serverId, String orbId, test.org.omg.PortableInterceptor.ObjectReferenceTemplate poaTemplate)
  {
            test.org.omg.CORBA.portable.InputStream $in = null;
            try {
                test.org.omg.CORBA.portable.OutputStream $out = _request ("poaDestroyed", true);
                test.org.omg.PortableInterceptor.ServerIdHelper.write ($out, serverId);
                test.org.omg.PortableInterceptor.ORBIdHelper.write ($out, orbId);
                test.org.omg.PortableInterceptor.ObjectReferenceTemplateHelper.write ($out, poaTemplate);
                $in = _invoke ($out);
  ...
  /** Find the server template that corresponds to the ORBD's
  	* adapter id.
  	*/
  public test.org.omg.PortableInterceptor.ObjectReferenceTemplate lookupPOATemplate (String serverId, String orbId, String[] orbAdapterName)
  {
            test.org.omg.CORBA.portable.InputStream $in = null;
            try {
                test.org.omg.CORBA.portable.OutputStream $out = _request ("lookupPOATemplate", true);
                test.org.omg.PortableInterceptor.ServerIdHelper.write ($out, serverId);
                test.org.omg.PortableInterceptor.ORBIdHelper.write ($out, orbId);
                test.org.omg.PortableInterceptor.AdapterNameHelper.write ($out, orbAdapterName);
                $in = _invoke ($out);
                test.org.omg.PortableInterceptor.ObjectReferenceTemplate $result = test.org.omg.PortableInterceptor.ObjectReferenceTemplateHelper.read ($in);
                return $result;
            } catch (test.org.omg.CORBA.portable.ApplicationException $ex) {
