...
abstract public class ServerDefHelper
{
  ...
  public static void insert (test.org.omg.CORBA.Any a, com.sun.corba.se.PortableActivationIDL.RepositoryPackage.ServerDef that)
  {
  ...
  public static com.sun.corba.se.PortableActivationIDL.RepositoryPackage.ServerDef extract (test.org.omg.CORBA.Any a)
  {
    ...
    if (__typeCode == null)
    {
      synchronized (test.org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          __active = true;
          test.org.omg.CORBA.StructMember[] _members0 = new test.org.omg.CORBA.StructMember [6];
          ...
          _members0[4] = new test.org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          _tcOf_members0 = test.org.omg.CORBA.ORB.init ().get_primitive_tc (test.org.omg.CORBA.TCKind.tk_boolean);
          _members0[5] = new test.org.omg.CORBA.StructMember (
            "isInstalled",
            _tcOf_members0,
            null);
          __typeCode = test.org.omg.CORBA.ORB.init ().create_struct_tc (com.sun.corba.se.PortableActivationIDL.RepositoryPackage.ServerDefHelper.id (), "ServerDef", _members0);
          __active = false;
        }
      }
    }
  ...
  public static com.sun.corba.se.PortableActivationIDL.RepositoryPackage.ServerDef read (test.org.omg.CORBA.portable.InputStream istream)
  {
  ...
  public static void write (test.org.omg.CORBA.portable.OutputStream ostream, com.sun.corba.se.PortableActivationIDL.RepositoryPackage.ServerDef value)
  {
