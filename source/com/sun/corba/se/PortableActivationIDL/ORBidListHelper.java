...
abstract public class ORBidListHelper
{
  ...
  synchronized public static test.org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = test.org.omg.CORBA.ORB.init ().create_alias_tc (test.org.omg.PortableInterceptor.ORBIdHelper.id (), "ORBId", __typeCode);
      __typeCode = test.org.omg.CORBA.ORB.init ().create_sequence_tc (0, __typeCode);
      __typeCode = test.org.omg.CORBA.ORB.init ().create_alias_tc (com.sun.corba.se.PortableActivationIDL.ORBidListHelper.id (), "ORBidList", __typeCode);
    }
    return __typeCode;
  }
  ...
  public static String[] read (test.org.omg.CORBA.portable.InputStream istream)
  {
    ...
    for (int _o1 = 0;_o1 < value.length; ++_o1)
      value[_o1] = test.org.omg.PortableInterceptor.ORBIdHelper.read (istream);
    return value;
  }
  ...
  public static void write (test.org.omg.CORBA.portable.OutputStream ostream, String[] value)
  {
    ...
    for (int _i0 = 0;_i0 < value.length; ++_i0)
      test.org.omg.PortableInterceptor.ORBIdHelper.write (ostream, value[_i0]);
  }
