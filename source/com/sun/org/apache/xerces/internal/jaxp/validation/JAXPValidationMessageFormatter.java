...
final class JAXPValidationMessageFormatter {
    ...
    public static String formatMessage(Locale locale,
        ...
        if (locale != null) {
            resourceBundle =
                SecuritySupport.getResourceBundle("com.sun.test.org.apache.xerces.internal.impl.msg.JAXPValidationMessages", locale);
        }
        else {
            resourceBundle =
                SecuritySupport.getResourceBundle("com.sun.test.org.apache.xerces.internal.impl.msg.JAXPValidationMessages");
        }
